---
title: "Source Digest — Kuran & Sunstein, \"Availability Cascades and Risk Regulation\" (1999)"
source_type: peer_reviewed_article
source_title: "Availability Cascades and Risk Regulation"
source_author: "Timur Kuran and Cass R. Sunstein"
source_publication: "Stanford Law Review"
source_date: 1999-04-01
source_url: "https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=2046&context=law_and_economics"
source_url_secondary: "https://scholar.harvard.edu/sunstein/publications/availability-cascades-and-risk-regulation"
provenance: "collaborative"
viewpoint: "centrist / behavioral-regulatory"
sub_debates: [7]
copyright_notice: "Both authors' working-paper versions are freely available. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — Kuran & Sunstein, "Availability Cascades and Risk Regulation"
...
| Field | Value |
|---|---|
| **Authors** | Timur Kuran (Duke) and Cass R. Sunstein (Harvard) |
| **Publication** | *Stanford Law Review* 51(4), April 1999 |
| **Free versions** | [Chicago Law & Economics WP 70](https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=2046&context=law_and_economics); [Harvard archive](https://scholar.harvard.edu/sunstein/publications/availability-cascades-and-risk-regulation) |
...
|---|---|---|
| Availability cascade mechanism | **Corroborated** | Now standard in behavioral economics, social psychology, and regulatory theory. |
| Specific case studies (Love Canal, Alar) | **Corroborated in substantial outline; specific numerical claims sometimes debated** | The retrospective consensus is that both episodes involved substantial risk overstatement, though the original communities' grievances were not entirely groundless. |
| Cost-benefit review reduces cascade-driven regulation | **Partially corroborated** | OIRA cost-benefit review has demonstrably altered some regulatory decisions. Its effectiveness depends on administration-specific enforcement. |
| Cascade dynamics explain much of contemporary risk politics | **Partially corroborated** | Strong in specific cases; competing frameworks (cultural cognition, moral-foundations theory) offer complementary accounts. |
...
|---|---|
| [Sunstein, Laws of Fear](source-sunstein-precautionary-digest.md) | Same author tradition; the book extends the article's framework. |
| [Germany Energiewende](source-germany-energiewende-digest.md) | Energiewende is a canonical real-world instance of availability-cascade policy. |
| [Caplan, Myth of the Rational Voter](source-caplan-myth-rational-voter-digest.md) | Parallel mechanism on the voter-belief side. |
| [Hacker & Pierson, Winner-Take-All Politics](source-hacker-pierson-winner-take-all-digest.md) | Availability entrepreneurs are part of Hacker-Pierson's organized-combat framework. |
