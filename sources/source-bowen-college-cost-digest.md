---
title: "Source Digest — Higher Education Cost Literature (Bowen, Archibald & Feldman, Bennett Hypothesis)"
source_type: book_and_working_paper_cluster
source_title: "The Costs of Higher Education (Bowen 1980) + Why Does College Cost So Much? (Archibald & Feldman 2011) + Accounting for the Rise in College Tuition (Gordon & Hedlund NBER 2017) + The Bennett Hypothesis"
source_author: "Howard Bowen; Robert Archibald and David Feldman; Grey Gordon and Aaron Hedlund; William Bennett (originator of the hypothesis named after him)"
source_publication: "Multiple venues"
source_date: 2017-09-01
source_url: "https://www.nber.org/papers/w21967"
source_url_secondary: "https://www.aeaweb.org/articles?id=10.1257/jep.31.3.193"
provenance: "collaborative"
viewpoint: "mixed — spans pro-market, cost-disease, and supply-side accounts"
sub_debates: [6]
copyright_notice: "NBER working papers and JEP articles are freely available. Book excerpts are included for analytical commentary under fair use."
---

# Source Digest — Higher Education Cost Literature
...
| Field | Value |
|---|---|
| **Canonical theoretical source** | Howard Bowen, *The Costs of Higher Education*, Jossey-Bass, 1980 ("Bowen's Revenue Theory") |
| **Cost-disease-centered account** | Robert Archibald & David Feldman, *Why Does College Cost So Much?*, Oxford University Press, 2011; [summary in JEP 2017](https://www.aeaweb.org/articles?id=10.1257/jep.31.3.193) |
| **Subsidy-driven account (Bennett Hypothesis)** | Gordon & Hedlund, "Accounting for the Rise in College Tuition," [NBER WP 21967 (2017)](https://www.nber.org/papers/w21967); earlier framing from [William Bennett's 1987 NYT op-ed](https://www.nytimes.com/1987/02/18/opinion/our-greedy-colleges.html) |
| **Empirical review** | [Lucca, Nadauld & Shen, Federal Reserve (2015)](https://libertystreeteconomics.newyorkfed.org/2015/07/the-student-loan-landscape.html) |
...
|---|---|---|
| Cost disease explains part of tuition inflation | **Corroborated** | Standard finding; Archibald & Feldman is the central reference. |
| Bennett hypothesis has significant empirical support | **Partially corroborated** | Gordon & Hedlund (2017) is the strongest quantitative evidence; earlier reduced-form studies were mixed. |
| Declining state appropriations explain much of public-tuition inflation | **Corroborated** | [SHEEO data](https://shef.sheeo.org/) is clear on this. |
| The problem is "too much government subsidy" | **Debated** | The Bennett effect is real but coexists with declining state appropriations; the overall government financial role in higher education has in some ways *decreased* per student even as tuition has risen. |
...
|---|---|
| [Perry, Chart of the Century](source-perry-chart-of-the-century-digest.md) | Tuition is the single most dramatic line on the chart; this literature decomposes it. |
| [Baumol, Cost Disease](source-baumol-cost-disease-digest.md) | Provides the structural baseline that both Archibald-Feldman and Gordon-Hedlund build on. |
| [Mercatus, Regulatory Accumulation](source-mercatus-regulatory-accumulation-digest.md) | Compliance cost in higher education is a specific instance of regulatory-accumulation logic. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Klein-Thompson's "build more" framing is especially relevant to supply-side tuition reform. |
