---
title: "Source Digest — Rodrik, The Globalization Trilemma and *Economics Rules*"
source_type: academic_essay_and_book_summary
source_title: "The Political Trilemma of the World Economy + *Economics Rules* (2015)"
source_author: "Dani Rodrik"
source_publication: "Journal of Economic Perspectives and multiple venues (2000 onward); W.W. Norton for the book"
source_date: 2015-10-13
source_url: "https://drodrik.scholar.harvard.edu/files/dani-rodrik/files/how-far-will-international-economic-integration-go.pdf"
source_url_secondary: "https://drodrik.scholar.harvard.edu/"
provenance: "collaborative"
viewpoint: "heterodox / institutionalist pluralism"
sub_debates: [5, 8]
copyright_notice: "Rodrik's working-paper and JEP versions are freely available via his Harvard faculty site. Excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Author** | Dani Rodrik (Harvard Kennedy School) |
| **Trilemma paper** | ["How Far Will International Economic Integration Go?" *Journal of Economic Perspectives* 14(1), 2000](https://drodrik.scholar.harvard.edu/files/dani-rodrik/files/how-far-will-international-economic-integration-go.pdf); restated in *The Globalization Paradox* (W. W. Norton, 2011) |
| **Book** | *Economics Rules: The Rights and Wrongs of the Dismal Science*, W. W. Norton, 2015 |
| **Faculty page** | [Rodrik at Harvard](https://drodrik.scholar.harvard.edu/) (free working paper archive) |
...
- Rodrik argues that a country can have at most two of three things simultaneously:
  1. **Deep economic integration** with the rest of the world (free movement of goods, capital, and people).
  2. **Democratic politics** — meaningful popular control over the rules of the economy.
  3. **National sovereignty** — independent national policy-making.
...
|---|---|---|
| Trilemma is logically coherent | **Corroborated** | Widely discussed in international political economy; formally defensible as a scarcity-of-policy-space argument. |
| Historical support for the trilemma | **Partially corroborated** | 2008-2026 political backlash against globalization is broadly consistent with the prediction that democracy + sovereignty require bounded integration. Euro crisis is a near-textbook case. |
| "One economics, many recipes" outperforms monism | **Debated** | Most mainstream economists would grant some form of contextual policy dependence; the strong-form pluralism Rodrik advances is contested by more universalist authors. |
...
|---|---|
| [Acemoglu & Robinson, Why Nations Fail](source-acemoglu-robinson-why-nations-fail-digest.md) | Compatible institutional framework; Rodrik adds the trilemma dimension. |
| [Sachs / Andersen Nordic Model](source-sachs-nordic-model-digest.md) | Nordic cases are instances of the Bretton Woods Compromise quadrant. |
| [Heritage/Fraser Economic Freedom Indexes](source-economic-freedom-index-digest.md) | Rodrik would read the indexes as measuring one axis of the trilemma but obscuring the tradeoffs. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Klein-Thompson's pragmatic mixed-ownership framework is compatible with Rodrik's "many recipes." |
