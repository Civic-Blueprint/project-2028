---
title: "Source Digest — Baumol, Cost Disease (1967 paper + 2012 book)"
source_type: academic_paper_and_book
source_title: "Macroeconomics of Unbalanced Growth: The Anatomy of Urban Crisis (1967) + The Cost Disease: Why Computers Get Cheaper and Health Care Doesn't (2012)"
source_author: "William J. Baumol (1967); Baumol, de Ferranti, Malach, Pablos-Méndez, Tabish, Wu (2012 book)"
source_publication: "American Economic Review (1967); Yale University Press (2012)"
source_date: 1967-06-01
source_url: "https://www.jstor.org/stable/1812111"
source_url_secondary: "https://yalebooks.yale.edu/book/9780300198157/the-cost-disease/"
provenance: "collaborative"
viewpoint: "heterodox / mainstream economics of service-sector inflation"
sub_debates: [6]
copyright_notice: "1967 paper available via JSTOR and library institutional access; free working-paper versions circulate. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — Baumol, Cost Disease
...
| Field | Value |
|---|---|
| **Author** | William J. Baumol (1922–2017; Princeton and NYU) |
| **Canonical paper** | "Macroeconomics of Unbalanced Growth: The Anatomy of Urban Crisis," *American Economic Review* 57(3), 1967 |
| **Free working-paper equivalents** | [Baumol, "Health Care, Education, and the Cost Disease" (Journal of Benefit-Cost Analysis, 2012)](https://www.cambridge.org/core/journals/journal-of-benefit-cost-analysis/article/abs/health-care-education-and-the-cost-disease-a-looming-crisis-for-public-choice/2A6EC9C7A9D6B1F6F7CE2B2BD4DE45C1) |
| **Book** | *The Cost Disease: Why Computers Get Cheaper and Health Care Doesn't*, Yale UP, 2012 |
...
|---|---|---|
| Mechanism is empirically robust | **Corroborated** | See [Nordhaus (2008)](https://cowles.yale.edu/sites/default/files/files/pub/d15/d1511.pdf) for a review; reproduced across OECD data. |
| Cost disease appears across institutional types | **Corroborated** | OECD health-cost trajectories confirm this; cost disease occurs in both NHS-style and U.S.-style systems, though the U.S. level is higher due to additional institutional inefficiencies. |
| Cost disease is affordable in the aggregate | **Corroborated in principle, problematic in distribution** | Aggregate affordability is arithmetic; distributional affordability depends on whether productivity gains are broadly shared. See [Piketty, *Capital*](source-piketty-capital-21c-digest.md). |
| The "solution" is distributional, not deregulatory | **Debated** | Most economists accept the core analysis; the distributional remedies are politically contested. |
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Central structural source for Sub-debate 6.
- **Problem Map:** [Domain 6 (Healthcare)](../PROBLEM_MAP.md#6-healthcare-is-too-often-rationed-by-price-complexity-and-access), [Domain 7 (Education)](../PROBLEM_MAP.md#7-education-and-opportunity-pathways-are-uneven-rigid-and-bottlenecked), [Domain 9 (Family support, including childcare)](../PROBLEM_MAP.md#9-family-support-systems-are-misaligned-with-modern-life). Baumol's cost-disease mechanism is the structural baseline against which the project's "scarcity is partly designed" framing must distinguish itself — labor-intensive service sectors will see relative-price growth even before regulatory and policy distortions are layered on.
- **Principles:** Directly informs [Principle 2 (essential needs should not be held hostage to avoidable scarcity)](../PRINCIPLES.md#2-essential-needs-should-not-be-held-hostage-to-avoidable-scarcity) — Baumol's mechanism explains why several of §2's enumerated essential needs (healthcare, education, childcare) systematically cost-inflate in productive economies, which directly bears on what counts as "avoidable" scarcity vs. structural economic feature. Informs [Principle 5 (critical systems require public-interest governance)](../PRINCIPLES.md#5-critical-systems-require-public-interest-governance) — cost-disease-affected sectors are disproportionately the labor-intensive human services §5 names as critical systems, and the diagnosis bears on whether public-interest governance is sufficient or whether productivity-side intervention is also required.
- **Round 2 use:** Primary citation for decomposing the Perry chart and for the "distributional problem, not productivity problem" reframe.
...
|---|---|
| [Perry, Chart of the Century](source-perry-chart-of-the-century-digest.md) | Baumol is the single most important lens on Perry's data. |
| [Chetty / healthcare-price literature](source-chetty-healthcare-prices-digest.md) | Empirical decomposition of U.S. healthcare price divergence. |
| [Piketty, Capital in the Twenty-First Century](source-piketty-capital-21c-digest.md) | The distributional side of the cost-disease story. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Klein-Thompson's supply-side critique complements Baumol's distributional critique. |
