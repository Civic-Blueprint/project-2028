---
title: "Source Digest — Acemoglu & Robinson, *Why Nations Fail* (2012) and Institutional Economics"
source_type: book_summary
source_title: "Why Nations Fail: The Origins of Power, Prosperity, and Poverty"
source_author: "Daron Acemoglu and James A. Robinson"
source_publication: "Crown Business / Currency (2012); 2024 Nobel citation"
source_date: 2012-03-20
source_url: "https://www.nobelprize.org/prizes/economic-sciences/2024/summary/"
source_url_secondary: "https://whynationsfail.com/"
provenance: "collaborative"
viewpoint: "pro-market / institutionalist (inclusive-extractive framework)"
sub_debates: [5, 8]
copyright_notice: "The 2024 Nobel committee summary is public. Book excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Authors** | Daron Acemoglu (MIT), James A. Robinson (University of Chicago); the 2024 Nobel also covered Simon Johnson (MIT) |
| **Publication** | *Why Nations Fail*, Crown Business, 2012 |
| **Companion free sources** | [Nobel committee scientific background (2024)](https://www.nobelprize.org/uploads/2024/09/advanced-economicsciencesprize2024.pdf); [blog archive at whynationsfail.com](https://whynationsfail.com/); [Acemoglu-Robinson 2005 *Handbook of Economic Growth* chapter (ungated preprint)](https://economics.mit.edu/sites/default/files/publications/institutions-as-a-fundamental-cause-of-long-run-growth.pdf) |
| **Related digest** | [Higgs, Crisis, Bigger Government](source-higgs-crisis-ratchet-digest.md) for the complementary ratchet account |
...
|---|---|---|
| Institutions are the primary determinant of long-run prosperity | **Corroborated, with reservations** | The 2024 Nobel endorsed this general finding. Critics (Sachs, Bloom) argue geography and human-capital variables retain independent explanatory power. |
| Inclusive-extractive typology is useful comparatively | **Corroborated** | Framework is widely used in comparative political economy. The binary is acknowledged as a simplification. |
| Creative destruction requires inclusive institutions | **Corroborated theoretically and empirically** | Patent-renewal, firm-entry, and innovation-survey data across countries all support this. |
| Critical junctures explain much of cross-country variation | **Partially corroborated** | Path-dependence is real; the *specific* critical junctures identified are sometimes debated by historians. |
| 2024 Nobel prize recognition | **Fact** | [Official citation](https://www.nobelprize.org/prizes/economic-sciences/2024/summary/) explicitly for "studies of how institutions are formed and affect prosperity." |
...
- **Problem Map:** [Domain 4 (Institutional capacity)](../PROBLEM_MAP.md#4-institutional-capacity-is-too-weak-for-the-demands-placed-on-it), [Domain 13 (Institutional distrust)](../PROBLEM_MAP.md#13-institutional-distrust-is-becoming-a-governing-condition), and [Domain 15 (Democratic process)](../PROBLEM_MAP.md#15-democratic-process-cannot-convert-public-need-into-institutional-action-at-the-speed-or-scale-required). Acemoglu-Robinson's inclusive-vs-extractive distinction is the direct theoretical antecedent for §4's institutional-capacity framing and §15's "speed or scale required" framing.
...
|---|---|
| [Lindert, *Growing Public*](source-lindert-growing-public-digest.md) | Lindert's "free-lunch" finding is consistent with A&R's inclusive-institutions framework. |
| [Ostrom, *Governing the Commons*](source-ostrom-governing-commons-digest.md) | Ostrom's design principles are a micro-level specification of what inclusive economic institutions look like in commons contexts. |
| [Piketty, *Capital in the Twenty-First Century*](source-piketty-capital-21c-digest.md) | Piketty's r > g is a mechanism by which inclusive institutions drift toward extractive ones. |
| [Buchanan & Tullock, *Calculus of Consent*](source-buchanan-tullock-calculus-consent-digest.md) | A&R's inclusive institutions are, in Buchanan's framework, those whose constitutive rules broadly distribute power. |
