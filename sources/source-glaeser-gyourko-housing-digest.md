...
- **Problem Map:** [Domain 1 (Housing)](../PROBLEM_MAP.md#1-housing-has-decoupled-from-wages), [Domain 8 (Urbanization and mobility)](../PROBLEM_MAP.md#8-urbanization-is-squeezing-labor-mobility).
- **Principles:** Directly relevant to [Principle 1 (dignity)](../PRINCIPLES.md#1-human-dignity-is-non-negotiable) — housing affordability is a dignity precondition. Supports [Principle 2 (common inheritance)](../PRINCIPLES.md#2-the-inheritance-of-humanity-belongs-to-all-of-humanity) — land is inherited and its use should serve broader communities, not only current owners.
