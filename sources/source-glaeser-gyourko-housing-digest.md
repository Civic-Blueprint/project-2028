---
title: "Source Digest — Glaeser, Gyourko, and the Zoning-as-Cause-of-Housing-Inflation Literature"
source_type: peer_reviewed_article_cluster
source_title: "The Impact of Zoning on Housing Affordability (Glaeser & Gyourko 2002) + The Economic Implications of Housing Supply (Glaeser & Gyourko 2018)"
source_author: "Edward L. Glaeser and Joseph Gyourko (with others)"
source_publication: "Harvard Institute of Economic Research; Journal of Economic Perspectives"
source_date: 2018-01-01
source_url: "https://www.aeaweb.org/articles?id=10.1257/jep.32.1.3"
source_url_secondary: "https://scholar.harvard.edu/glaeser/publications/impact-zoning-housing-affordability"
provenance: "collaborative"
viewpoint: "pro-market-adjacent / supply-side empirical"
sub_debates: [6]
copyright_notice: "NBER and JEP versions are freely available. Excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Authors** | Edward L. Glaeser (Harvard) and Joseph Gyourko (Wharton) |
| **Canonical 2002 paper** | "The Impact of Zoning on Housing Affordability," [NBER WP 8835 (2002)](https://www.nber.org/papers/w8835) |
| **Canonical 2018 paper** | "The Economic Implications of Housing Supply," [*Journal of Economic Perspectives* 32(1), 2018](https://www.aeaweb.org/articles?id=10.1257/jep.32.1.3) |
| **Companion Hsieh-Moretti paper** | ["Housing Constraints and Spatial Misallocation," *AEJ: Macro* 11(2), 2019](https://www.aeaweb.org/articles?id=10.1257/mac.20170388) |
...
|---|---|---|
| Housing prices exceed construction costs in restricted metros | **Corroborated** | Widely replicated using CoStar, Zillow, Census data. |
| The gap is driven primarily by regulation | **Corroborated** | Cross-metro evidence, time-series evidence, and specific-regulation studies (CA, MA, NY) converge. |
| Restrictive zoning produces substantial aggregate welfare losses | **Corroborated quantitatively; precise magnitudes debated** | Hsieh-Moretti (2019) is the most widely-cited estimate; more recent work ([Herkenhoff, Ohanian, Prescott (2018)](https://www.nber.org/papers/w23790)) produces smaller but still large estimates. |
| Reform is politically feasible | **Partially corroborated** | State-level preemption in CA, OR, ME, MT has passed. Local-level opposition remains strong. |
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Essential sector-specific evidence for Sub-debate 6.
- **Problem Map:** [Domain 5 (Housing)](../PROBLEM_MAP.md#5-housing-is-constrained-where-it-should-be-abundant) — Glaeser-Gyourko's regulatory-tax decomposition is the canonical empirical anchor for §5's "constrained where it should be abundant" framing. Also bears on [Domain 4 (Institutional capacity)](../PROBLEM_MAP.md#4-institutional-capacity-is-too-weak-for-the-demands-placed-on-it) — the binding constraint operates through institutional-capacity failure at the local-permitting layer.
- **Principles:** Directly relevant to [Principle 2 (essential needs should not be held hostage to avoidable scarcity)](../PRINCIPLES.md#2-essential-needs-should-not-be-held-hostage-to-avoidable-scarcity) — housing is the lead example in §2's enumerated list of essential needs, and Glaeser-Gyourko's "regulatory tax" on construction is the canonical case of *avoidable* scarcity that §2 names. Also supports [Principle 1 (dignity is inherent and unconditional)](../PRINCIPLES.md#1-dignity-is-inherent-and-unconditional) — housing affordability is a dignity precondition — and [Principle 17 (collective power must be exercised within principled constraints)](../PRINCIPLES.md#17-collective-power-must-be-exercised-within-principled-constraints), which directly cites preemption of local zoning that blocks housing as the worked example of legitimate collective power under §2.
...
|---|---|
| [Perry, Chart of the Century](source-perry-chart-of-the-century-digest.md) | Provides the aggregate housing line this literature explains. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Klein-Thompson's zoning-liberalization program is directly derived from this literature. |
| [Mercatus, Regulatory Accumulation](source-mercatus-regulatory-accumulation-digest.md) | Complementary — zoning is a specific instance of the regulatory-accumulation dynamic. |
| [Ostrom, Governing the Commons](source-ostrom-governing-commons-digest.md) | Ostrom's framework applied to land use produces polycentric but non-restrictive reform directions. |
