---
title: "Source Digest — Keynes, \"Economic Possibilities for Our Grandchildren\" (1930)"
source_type: essay
source_title: "Economic Possibilities for Our Grandchildren"
source_author: "John Maynard Keynes"
source_publication: "Nation and Athenaeum (1930); reprinted in *Essays in Persuasion* (1931)"
source_date: 1930-10-11
source_url: "http://www.econ.yale.edu/smith/econ116a/keynes1.pdf"
source_url_secondary: "https://archive.org/details/in.ernet.dli.2015.222619"
provenance: "collaborative"
viewpoint: "heterodox / classic humanist abundance"
sub_debates: [4]
copyright_notice: "The essay is freely available in multiple public archives; works from 1930 are in public domain in most jurisdictions. Excerpts are used in full for analytical commentary."
---
...
| **First publication** | *Nation and Athenaeum*, October 11 and 18, 1930 |
| **Canonical reprint** | *Essays in Persuasion*, Macmillan, 1931, Ch. 5 |
| **Freely available full text** | [Yale Econ archive (PDF)](http://www.econ.yale.edu/smith/econ116a/keynes1.pdf); [Internet Archive scan](https://archive.org/details/in.ernet.dli.2015.222619) |
...
|---|---|---|
| 2% real growth over a century | **Corroborated** at the aggregate level for advanced economies | Per-capita GDP in U.S., UK, etc. has grown roughly as Keynes forecast. |
| Work hours would fall substantially | **Partially corroborated** | Work hours have declined (from ~48-hour weeks in 1930 to ~34–40 in 2026), but far less than the 15-hour work week Keynes implied. The "reduced work" forecast was substantially wrong. |
| Material needs would be met | **Partially corroborated** | Absolute poverty in advanced economies has fallen dramatically but is not eliminated; relative poverty and "economic insecurity" remain high by any historical comparison to 1930 expectations. |
| Money would cease to be a dominant cultural goal | **Contradicted** | By any observable measure (advertising, cultural production, political-economic discourse), money and consumption have become more culturally dominant, not less. |
...
- Keynes's diagnosis of the cultural problem — that we have trained ourselves in scarcity psychology and will have trouble exiting it — anticipates many contemporary debates about work, identity, and meaning. The persistence of long hours despite high per-capita output is one of the deepest puzzles in economic sociology. See [Schor, *The Overworked American*](https://www.hachettebookgroup.com/titles/juliet-b-schor/the-overworked-american/9780465054343/) for a 1992 treatment that still reads as current.
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Foundational humanist abundance source for Sub-debate 4.
- **Problem Map:** [Domain 11 (Post-scarcity potential)](../PROBLEM_MAP.md#11-a-post-scarcity-future-is-increasingly-possible-and-is-not-being-prepared-for), [Domain 12 (Meaning of work)](../PROBLEM_MAP.md#12-work-and-purpose-are-decoupling-faster-than-our-institutions-can-absorb).
- **Principles:** Directly informs [Principle 6 (the gains from automation should strengthen society, not destabilize it)](../PRINCIPLES.md#6-the-gains-from-automation-should-strengthen-society-not-destabilize-it) — Keynes's 1930 essay is the canonical 20th-century articulation of the productivity-then-leisure direction §6 implicitly assumes is achievable. Informs [Principle 7 (freedom requires both liberty and material stability)](../PRINCIPLES.md#7-freedom-requires-both-liberty-and-material-stability) — Keynes's "economic problem" is the material-stability prerequisite §7 names. Tests [Principle 2 (essential needs should not be held hostage to avoidable scarcity)](../PRINCIPLES.md#2-essential-needs-should-not-be-held-hostage-to-avoidable-scarcity) at the upper bound — once the "economic problem" is solved, *every* failure to meet essential needs is by construction avoidable, and §2's design-failure framing applies in its strongest form.
...
|---|---|
| [Diamandis, Abundance](source-diamandis-abundance-digest.md) | Contemporary techno-optimist continuation of Keynes's forecast. |
| [Andreessen, Techno-Optimist Manifesto](source-andreessen-techno-optimist-digest.md) | Polemical version that largely drops Keynes's humanist framing. |
| [Bastani, Fully Automated Luxury Communism](source-bastani-falc-digest.md) | Post-capitalist continuation; diagnoses ownership as the reason Keynes's distributive forecast failed. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Identifies state-capacity failures as a complementary reason the distributive forecast failed. |
| [Raworth, Doughnut Economics](source-raworth-doughnut-digest.md) | Ecological extension of Keynes's "permanent problem" framing. |
