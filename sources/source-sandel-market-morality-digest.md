---
title: "Source Digest — Sandel, *What Money Can't Buy* (2012) and the Moral Limits of Markets"
source_type: book_summary
source_title: "What Money Can't Buy: The Moral Limits of Markets"
source_author: "Michael J. Sandel"
source_publication: "Farrar, Straus and Giroux"
source_date: 2012-04-24
source_url: "https://www.nytimes.com/2012/04/15/books/review/what-money-cant-buy-by-michael-j-sandel.html"
source_url_secondary: "https://scholar.harvard.edu/sandel/home"
provenance: "collaborative"
viewpoint: "communitarian / civic-republican limits on markets"
sub_debates: [2, 8]
copyright_notice: "NYT review is freely available; Harvard faculty page provides free essays. Book excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Author** | Michael J. Sandel (Harvard) |
| **Publisher** | Farrar, Straus and Giroux, 2012 |
| **Free essays** | [Sandel's Harvard faculty page](https://scholar.harvard.edu/sandel/home); [*The Atlantic* "What Isn't for Sale?" essay (2012)](https://www.theatlantic.com/magazine/archive/2012/04/what-isnt-for-sale/308902/) |
| **Companion** | Sandel, *Democracy's Discontent* (1996) and *The Tyranny of Merit* (2020) |
...
|---|---|---|
| Markets can crowd out civic motivation | **Corroborated empirically in specific cases** | Titmuss on blood donation; Gneezy-Rustichini on daycare pickup fines; Frey et al. on environmental motivations. |
| Shared civic experience is important to democracy | **Corroborated theoretically; empirical measurement difficult** | Long tradition in political theory (Tocqueville, Putnam, Sandel); measurement of "civic-republican" effects is difficult but recent work on cross-class contact and political trust supports the direction. |
| The corruption objection is distinct from the inequality objection | **Corroborated analytically** | Sandel's analytical contribution is widely accepted even by those who disagree with his policy conclusions. |
| Public-ownership provision outperforms private for some goods | **Partially corroborated, context-dependent** | True for some goods (blood, basic utilities, parks) where civic/commons values are constitutive; not for all. |

---

## Interpretive notes

- Sandel is the project's most valuable civic-republican bridge. His framework does not fit cleanly into the pro-market/social-democratic axis; it introduces a third dimension (civic/commons) that is essential to the project's [Principle 5 (critical systems require public-interest governance)](../PRINCIPLES.md#5-critical-systems-require-public-interest-governance) and [Principle 17 (collective power must be exercised within principled constraints)](../PRINCIPLES.md#17-collective-power-must-be-exercised-within-principled-constraints), and to the deeper challenge Friedberg raises about democracy.
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Key heterodox bridge source for Sub-debates 2 and 8.
- **Problem Map:** [Domain 10 (Wealth and power concentration)](../PROBLEM_MAP.md#10-wealth-and-power-are-concentrating-faster-than-governance-can-respond), [Domain 15 (Democratic process)](../PROBLEM_MAP.md#15-democratic-process-cannot-convert-public-need-into-institutional-action-at-the-speed-or-scale-required), [Domain 13 (Institutional distrust)](../PROBLEM_MAP.md#13-institutional-distrust-is-becoming-a-governing-condition). Sandel's argument is that §10's concentration and §15's responsiveness gap are not just distributive problems but moral ones — and that §13's distrust dynamic is partly downstream of the slow erosion of shared moral language about what markets should and should not allocate.
...
|---|---|
| [Scanlon, Why Does Inequality Matter?](source-scanlon-inequality-matter-digest.md) | Both develop pluralist objections to market / inequality outcomes. |
| [Rawls, A Theory of Justice](source-rawls-theory-of-justice-digest.md) | Sandel was historically a critic of Rawls; they ultimately converge on many policy conclusions despite methodological differences. |
| [Ostrom, Governing the Commons](source-ostrom-governing-commons-digest.md) | Empirical-institutional foundation for Sandel's normative claims about commons. |
| [Nozick, Anarchy, State, and Utopia](source-nozick-anarchy-state-utopia-digest.md) | Direct philosophical opponent on the appropriate scope of markets. |
| [Keynes, Economic Possibilities for Our Grandchildren](source-keynes-grandchildren-digest.md) | Keynes's "permanent problem" is Sandel's civic-life problem in an earlier framing. |
