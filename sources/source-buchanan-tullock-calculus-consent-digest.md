---
title: "Source Digest — Buchanan & Tullock, *The Calculus of Consent* (1962)"
source_type: book_summary
source_title: "The Calculus of Consent: Logical Foundations of Constitutional Democracy"
source_author: "James M. Buchanan and Gordon Tullock"
source_publication: "University of Michigan Press (1962); freely available via Liberty Fund"
source_date: 1962-01-01
source_url: "https://oll.libertyfund.org/titles/buchanan-the-calculus-of-consent-logical-foundations-of-constitutional-democracy"
source_url_secondary: "https://plato.stanford.edu/entries/public-choice/"
provenance: "collaborative"
viewpoint: "pro-market / libertarian-constitutional (public choice)"
sub_debates: [3, 8]
copyright_notice: "The Liberty Fund edition is free. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — Buchanan & Tullock, *The Calculus of Consent*
...
| Field | Value |
|---|---|
| **Authors** | James M. Buchanan (Nobel, 1986) and Gordon Tullock |
| **Publication** | University of Michigan Press, 1962 |
| **Freely available edition** | [Liberty Fund Online Library of Liberty](https://oll.libertyfund.org/titles/buchanan-the-calculus-of-consent-logical-foundations-of-constitutional-democracy) |
| **Companion entry** | [Stanford Encyclopedia of Philosophy, "Public Choice"](https://plato.stanford.edu/entries/public-choice/) |

---

## Thematic cluster 1: two-stage consent (constitutional vs. operational)
...
|---|---|---|
| Two-level framework (constitutional vs. operational) | **Corroborated** as foundational to public-choice and constitutional economics | Widely accepted as the canonical framing; replicated in [Rawls's *A Theory of Justice*](https://www.hup.harvard.edu/books/9780674000780) with different normative underpinnings. |
| External-cost / decision-cost tradeoff | **Corroborated** theoretically | Standard in public-choice texts; see e.g., [Mueller, *Public Choice III*](https://www.cambridge.org/core/books/public-choice-iii/9F0C4A8A1C4D1C0D4E5F6A8B9C0D1E2F). Empirical calibration is contested. |
| Supermajority is optimal for high-stakes decisions | **Corroborated theoretically; debated normatively** | Progressive critics (Ackerman, Balkin) argue that supermajority biases the status quo and entrenches past injustices; Buchanan's response is that this is the intended function for constitutive rules. |
...
- **Problem Map:** [Domain 4 (Institutional capacity)](../PROBLEM_MAP.md#4-institutional-capacity-is-too-weak-for-the-demands-placed-on-it), [Domain 15 (Democratic process)](../PROBLEM_MAP.md#15-democratic-process-cannot-convert-public-need-into-institutional-action-at-the-speed-or-scale-required). Buchanan and Tullock's decision-cost / external-cost frame is the foundational treatment of the §15 question: how decision rules either enable or block conversion of public need into institutional action.
...
|---|---|
| [Caplan, Myth of the Rational Voter](source-caplan-myth-rational-voter-digest.md) | Public-choice voter-side companion; Buchanan provides the constitutional-design response to rational-irrationality pathologies. |
| [Gilens & Page, Testing Theories of American Politics](source-gilens-page-testing-theories-digest.md) | Empirical capture evidence that the two-level framework is meant to mitigate. |
| [Higgs, Crisis, Bigger Government](source-higgs-crisis-ratchet-digest.md) | The ratchet is, in Buchanan's terms, a failure of constitutive-level design that allows crisis-era operational decisions to become durable without constitutional scrutiny. |
