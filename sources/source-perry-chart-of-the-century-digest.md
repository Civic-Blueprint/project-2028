---
title: "Source Digest — Perry, \"Chart of the Century\" (AEI, 2016–)"
source_type: think_tank_commentary
source_title: "Chart of the Century (annual series): Price Changes, 1998–2024"
source_author: "Mark J. Perry (American Enterprise Institute)"
source_publication: "AEI Carpe Diem blog; periodically updated"
source_date: 2024-11-15
source_url: "https://www.aei.org/carpe-diem/chart-of-the-day-century/"
source_url_secondary: "https://fred.stlouisfed.org/graph/?g=1khM9"
provenance: "collaborative"
viewpoint: "pro-market / libertarian-empirical"
sub_debates: [6]
copyright_notice: "The chart and underlying data are publicly available. Excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Author** | Mark J. Perry (University of Michigan–Flint; AEI) |
| **Publication** | AEI Carpe Diem blog, updated approximately annually |
| **Canonical URL** | [aei.org/carpe-diem](https://www.aei.org/carpe-diem/chart-of-the-day-century/) |
| **Underlying data** | [BLS CPI component series](https://www.bls.gov/cpi/); reproducible via [FRED](https://fred.stlouisfed.org/) |
...
| Category | Approximate cumulative price change, Jan 1998 – Jul 2024 |
|---|---|
| Hospital services | +295% |
| College tuition and fees | +178% |
| College textbooks | +165% |
| Childcare and nursery school | +130% |
| Medical care services | +125% |
| Housing | +100% |
| Overall CPI | +85% |
| Average hourly earnings | +125% |
...
|---|---|---|
| Prices in Perry's sectors have risen faster than CPI | **Corroborated** | Data is public; no dispute on the fact. |
| The divergence is *caused* primarily by government subsidy / regulation | **Debated** | Baumol effects, supply-side restrictions, private-sector rent-extraction, and international-comparison evidence all complicate the story. |
| Sectors with less government show falling prices because of market discipline | **Partially corroborated** | True for several; also true that many fall because of globalization and technology, which are government-enabled (trade policy, public R&D). |
...
- **Problem Map:** [Domain 5 (Housing)](../PROBLEM_MAP.md#5-housing-is-constrained-where-it-should-be-abundant), [Domain 6 (Healthcare)](../PROBLEM_MAP.md#6-healthcare-is-too-often-rationed-by-price-complexity-and-access), [Domain 7 (Education)](../PROBLEM_MAP.md#7-education-and-opportunity-pathways-are-uneven-rigid-and-bottlenecked), and [Domain 9 (Family support, including childcare)](../PROBLEM_MAP.md#9-family-support-systems-are-misaligned-with-modern-life). Perry's chart is the single most cited cross-domain visualization of relative-price divergence, and it lands on exactly the four Problem Map domains where price-vs-quality decoupling is the project's central diagnostic.
...
|---|---|
| [Baumol, Cost Disease](source-baumol-cost-disease-digest.md) | The most important single alternative explanation. |
| [Chetty / healthcare-price literature](source-chetty-healthcare-prices-digest.md) | Disaggregates the Perry chart into components. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Uses similar data to draw supply-side progressive conclusions. |
| [Mercatus, Regulatory Accumulation](source-mercatus-regulatory-accumulation-digest.md) | Complementary ratchet-in-regulation story. |
