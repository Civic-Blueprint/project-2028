---
title: "Source Digest — Heritage and Fraser Economic Freedom Indexes"
source_type: think_tank_index
source_title: "Index of Economic Freedom (Heritage Foundation); Economic Freedom of the World Report (Fraser Institute)"
source_author: "Heritage Foundation; Fraser Institute"
source_publication: "Annual indexes, 1995–present"
source_date: 2025-01-01
source_url: "https://www.heritage.org/index/"
source_url_secondary: "https://www.fraserinstitute.org/economic-freedom/dataset"
provenance: "collaborative"
viewpoint: "pro-market / libertarian comparative rankings"
sub_debates: [5]
copyright_notice: "Both indexes publish rankings and underlying data freely. Excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Producing institutions** | Heritage Foundation (since 1995); Fraser Institute (since 1996) |
| **Canonical URLs** | [Heritage Index of Economic Freedom](https://www.heritage.org/index/); [Fraser Economic Freedom of the World dataset](https://www.fraserinstitute.org/economic-freedom/dataset) |
| **Companion peer-reviewed assessments** | [Gwartney, Hall & Lawson (Fraser annual reports)](https://www.fraserinstitute.org/economic-freedom/annual-report); [De Haan & Sturm (2000)](https://doi.org/10.1016/S0176-2680(00)00036-0) in *European Journal of Political Economy* |
...
| Country | Rank | Score | Tax-to-GDP (2023 OECD) |
|---|---|---|---|
| Singapore | 1 | 83.9 | ~13% |
| Ireland | 3 | 82.6 | ~20% |
| Denmark | 9 | 78.4 | ~44% |
| Finland | 11 | 77.5 | ~43% |
| Sweden | 15 | 76.5 | ~41% |
| United States | 25 | 70.1 | ~28% |
| Venezuela | 174 | 28.1 | varies, data poor |
...
|---|---|---|
| Economic freedom correlates with welfare outcomes | **Corroborated** | Direction and magnitude robust across indexes and studies. |
| Economic freedom causes welfare outcomes | **Partially corroborated** | Correlation is strong; causal identification is harder. See [Doucouliagos & Ulubaşoğlu (2006)](https://doi.org/10.1016/j.ejpoleco.2006.01.003) meta-analysis. |
| Nordic countries' high scores vindicate pro-market arguments | **Debated** | The indexes' own methodology acknowledges that large governments are compatible with high scores; this is more consistent with the Acemoglu-Robinson inclusive-institutions view than with a "small government is best" view. |
| Sub-component weighting is contested | **Corroborated** | Alternative weightings produce substantially different country rankings, particularly for countries with large public sectors. |
...
|---|---|
| [Acemoglu & Robinson, Why Nations Fail](source-acemoglu-robinson-why-nations-fail-digest.md) | The inclusive-institutions framework is what the indexes implicitly measure. |
| [Lindert, Growing Public](source-lindert-growing-public-digest.md) | Lindert's "free-lunch" finding explains why Nordic countries can combine high taxes with high rankings. |
| [OECD Revenue Statistics](source-oecd-revenue-statistics-digest.md) | Provides the tax-to-GDP data that, combined with the indexes, produces the conservative paradox. |
