---
title: "Source Digest — The German Energiewende and Nuclear Phaseout (2011–2026)"
source_type: policy_case_study_cluster
source_title: "Germany's Energiewende + Nuclear Phaseout: Outcomes and Assessment"
source_author: "Multiple (IEA; Fraunhofer ISE; Clean Energy Wire; MCC Berlin)"
source_publication: "Various reports and peer-reviewed analyses"
source_date: 2023-04-15
source_url: "https://www.iea.org/countries/germany"
source_url_secondary: "https://www.cleanenergywire.org/factsheets/germanys-energiewende-energy-transition-facts-and-figures"
provenance: "collaborative"
viewpoint: "mixed — policy case study spanning pro-market, pro-regulation, and ecological perspectives"
sub_debates: [7]
copyright_notice: "Primary sources are freely available via official agency and research-center publication. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — German Energiewende and Nuclear Phaseout
...
| Field | Value |
|---|---|
| **IEA country review** | [International Energy Agency — Germany](https://www.iea.org/countries/germany); [Germany 2020 Energy Policy Review](https://www.iea.org/reports/germany-2020) |
| **Clean Energy Wire factsheets** | [Germany's Energiewende — Facts and Figures](https://www.cleanenergywire.org/factsheets/germanys-energiewende-energy-transition-facts-and-figures) |
| **Peer-reviewed assessment** | [Jarvis, Deschenes & Jha (2022), "The Private and External Costs of Germany's Nuclear Phase-Out," *Journal of the European Economic Association* 20(3)](https://academic.oup.com/jeea/article/20/3/1311/6527683) |
| **Fraunhofer ISE Energy Charts** | [energy-charts.info](https://energy-charts.info) — real-time and historical generation data |
| **Policy coverage** | [MCC Berlin analyses](https://www.mcc-berlin.net/en/) |
...
|---|---|---|
| Phaseout led to higher fossil use than counterfactual | **Corroborated** | Jarvis et al. 2022 is the most careful academic estimate; the qualitative finding is broadly accepted. |
| Air-pollution mortality attributable to phaseout | **Corroborated directionally; magnitude debated** | JEEA estimate is central; other studies show similar direction, varying magnitudes. |
| Renewables capacity gains are real and valuable | **Corroborated** | Uncontroversial. |
| Phaseout was net-positive in aggregate | **Debated** | The aggregate accounting is contested; most serious analyses find the phaseout to have been net-negative in climate terms while net-positive in coalition-maintenance terms. |
...
|---|---|
| [Sunstein, Laws of Fear](source-sunstein-precautionary-digest.md) | The theoretical framework; Energiewende is a central case. |
| [Raworth, Doughnut Economics](source-raworth-doughnut-digest.md) | Energiewende is a climate-ceiling test; mixed results complicate doughnut operationalization. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Energiewende permitting and grid-expansion delays are part of the supply-side critique. |
