---
title: "Source Digest — Argentina Under Milei (2023–2026): Near-Contemporary Fiscal Contraction Under Democracy"
source_type: policy_case_study_cluster
source_title: "The Milei Reform Program and Its First 28 Months of Outcomes"
source_author: "Multiple (IMF Article IV + EFF program reviews; INDEC Argentina; CEPR / El País / National Interest / Wikipedia)"
source_publication: "Various (IMF staff reports; INDEC releases; major journalism)"
source_date: 2026-04-15
source_url: "https://www.imf.org/en/Countries/ARG"
source_url_secondary: "https://en.wikipedia.org/wiki/Economic_reforms_of_Javier_Milei"
provenance: "ai-generated, steward-curated"
viewpoint: "near-contemporary test of the Friedberg 'democracies cannot contract' claim"
sub_debates: [1, 3, 5, 8]
copyright_notice: "IMF staff reports and INDEC data are public. Journalistic excerpts are referenced for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Primary institutional sources** | [IMF Argentina country page](https://www.imf.org/en/Countries/ARG); IMF Executive Board statements on the 48-month Extended Fund Facility (EFF) approved April 2025 and subsequent reviews; [INDEC Argentina](https://www.indec.gob.ar/) |
| **Reference overview** | [Wikipedia: Economic reforms of Javier Milei](https://en.wikipedia.org/wiki/Economic_reforms_of_Javier_Milei) |
| **Contemporary journalism (April 2026)** | [El País: "Argentina's Milei is struggling with the economy and losing popularity" (12 Apr 2026)](https://english.elpais.com/international/2026-04-12/argentinas-milei-is-struggling-with-the-economy-and-losing-popularity.html); [Rio Times: "Argentina's Merval Breaks Kijun as IMF $1B Disbursement" (Apr 2026)](https://www.riotimesonline.com/merval-argentina-milei-approval-imf-disbursement/); [National Interest: "Has Javier Milei Cured Argentina's Economy?" (1 Apr 2026)](https://nationalinterest.org/feature/has-javier-milei-cured-argentinas-economy) |
| **Analytical overview** | [Capitalism Magazine: "Deregulation in Argentina" (Apr 2026)](https://capitalismmagazine.com/2026/04/deregulation-in-argentina-javier-milei-takes-deep-chainsaw-to-bureaucracy-and-red-tape/); [Friedrich Naumann Foundation: "Two years of Javier Milei" (Jan 2026)](https://www.freiheit.org/argentina-brazil-paraguay-and-uruguay/javier-milei-two-years-office-impressive-successes-and) |
...
| Metric | Dec 2023 | End-2024 | End-2025 | Apr 2026 |
|---|---|---|---|---|
| Primary balance (% GDP) | -3.0 | +1.8 | +1.8 | On track |
| Financial balance (% GDP) | -5.0 | +0.3 | ~0 | Small surplus |
| Monthly CPI | 25.5% | ~2.7% (avg H2 2024) | ~2.4% (avg 2025) | 3.4% (March 2026, accelerating) |
| Annual CPI | 211% | 117% | 31% | Above target |
| Net international reserves | -US$11B | -US$7B | +US$5B | Stable |
| Central-bank remunerated liabilities | ~20% GDP | largely unwound | ~0 | resolved |
...
2. **The contraction path is painful but tractable when the starting condition is dire enough to eliminate the status-quo option.** Argentina's pre-Milei path was unambiguously unsustainable; the electorate did not choose contraction over a viable alternative, they chose contraction over imminent collapse.

3. **Fiscal rules plus external anchor (IMF program) plus legal entrenchment of specific reforms (RIGI, Ley de Bases) reinforce sustainability.** The program has survived multiple political crises because the fiscal surplus has been codified and monitored.

4. **Macroeconomic success does not automatically translate to political support.** Approval has fallen even as headline metrics have improved, because the *distributional* incidence of the contraction has been regressive (pensioners, public employees, provincial workers absorb the largest share of the cuts), and because continuing inflation keeps daily pressure on households.

### What it does not prove

1. **It does not prove democratic contraction works in non-crisis conditions.** The Argentine electorate chose contraction under hyperinflation conditions. The U.S. is nowhere near analogous conditions; the relevance to a Friedberg-style "contract from 16–18% GDP revenue" argument is highly attenuated.

2. **It does not prove the reform will be sustained past October 2026.** A midterm loss could restore a veto-playing Congress and unwind portions of the program. The pattern of Argentine history is cyclical reform-then-reversal.

3. **It does not resolve the distributional question.** The program has been effective at stabilization; it has been distributionally regressive. The longer-run question is whether the poverty and wage recovery trajectories will substantiate the "growth will pay the bills" claim. Early-2026 evidence is suggestive but not conclusive.

4. **It does not refute the broader inclusiveness critique.** Milei's deregulation program has reduced institutional oversight in areas (environmental, media, judicial) where the project's Acemoglu-Robinson inclusive-institutions framing (Sub-debate 5) would expect concern about extractive drift. The case is more mixed on institutional-quality grounds than its pro-market reading suggests.
...
|---|---|---|
| Argentina achieved and maintained primary fiscal surplus under Milei | **Corroborated** | IMF, INDEC, multiple independent sources |
| Inflation fell from 211% (2023) to 31% (2025), with recent re-acceleration | **Corroborated** | INDEC monthly data |
| Poverty initially rose then fell below starting level | **Corroborated** with distributional caveat | INDEC methodology acknowledges averaging compresses distributional stress |
| Reform program transfers to U.S. or other non-crisis democracies | **Contested** | Starting conditions are not comparable |
| The contraction will be sustained past 2026 midterms | **Open** | October 2026 election is the test |
...
|---|---|
| [Fiscal Consolidation Cases (Canada 1990s, Sweden 1990s, NZ 1984)](source-fiscal-consolidation-cases-digest.md) | Historical companions to the Argentine contemporary case |
| [Higgs, Crisis, Bigger Government](source-higgs-crisis-ratchet-digest.md) | Argentina inverts the Higgs crisis-ratchet: crisis produced contraction rather than expansion |
| [Buchanan & Tullock, Calculus of Consent](source-buchanan-tullock-calculus-consent-digest.md) | RIGI and Ley de Bases as constitutional-level entrenchment devices |
| [Acemoglu & Robinson, Why Nations Fail](source-acemoglu-robinson-why-nations-fail-digest.md) | Mixed: reform addresses some extractive legacies, introduces new concerns on institutional deconsolidation |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Argentine deregulation functions as an extreme case of the supply-side-state-capacity argument |
