---
title: "Source Digest — Sunstein, *Laws of Fear* (2005) and the Precautionary Principle Literature"
source_type: book_summary
source_title: "Laws of Fear: Beyond the Precautionary Principle"
source_author: "Cass R. Sunstein"
source_publication: "Cambridge University Press (Seeley Lectures)"
source_date: 2005-04-04
source_url: "https://www.cambridge.org/core/books/laws-of-fear/9CB8A2F18E5B91FC4FBA6F9B7B4C16BB"
source_url_secondary: "https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=1514&context=law_and_economics"
provenance: "collaborative"
viewpoint: "centrist / empirical-behavioral regulatory theory"
sub_debates: [7]
copyright_notice: "Sunstein's working-paper versions are freely available via Chicago and Harvard repositories. Excerpts are included for analytical commentary under fair use."
---
...
| Field | Value |
|---|---|
| **Author** | Cass R. Sunstein (Harvard; former OIRA administrator under Obama) |
| **Book** | *Laws of Fear: Beyond the Precautionary Principle*, Cambridge UP (Seeley Lectures), 2005 |
| **Free working-paper version** | [Chicago Law & Economics WP 225, "Beyond the Precautionary Principle"](https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=1514&context=law_and_economics) |
| **Related companion paper** | Sunstein & Vermeule, ["Interpretation and Institutions"](https://dash.harvard.edu/handle/1/12921699) |
...
|---|---|---|
| Strong precautionary principle is formally incoherent | **Corroborated** | Central argument is widely accepted across the regulatory-theory literature. |
| Risk-risk tradeoffs are empirically important | **Corroborated** | Extensive literature on drug lag, pesticide substitution, nuclear phaseouts, etc. |
| Narrow anti-catastrophe principle is defensible | **Corroborated** as a refinement | Variant formulations in [Parfit, *On What Matters*](https://global.oup.com/academic/product/on-what-matters-9780199572816), [Nordhaus on climate](https://www.degruyter.com/document/doi/10.1515/9780300227734/html), [Bostrom on existential risk](https://existential-risk.org/). |
| Availability cascades systematically distort risk perception | **Corroborated** | [Kuran & Sunstein, "Availability Cascades and Risk Regulation"](https://scholar.harvard.edu/sunstein/publications/availability-cascades-and-risk-regulation) is the canonical article. |
...
|---|---|
| [Germany Energiewende case study](source-germany-energiewende-digest.md) | A specific case where precautionary nuclear phaseout produced measurably higher climate-risk outcomes. |
| [Caplan, Myth of the Rational Voter](source-caplan-myth-rational-voter-digest.md) | Availability-cascade dynamics are partly the same phenomenon Caplan describes as rational irrationality. |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Supply-side progressive critique shares Sunstein's concern with procedural over-caution. |
| [Buchanan & Tullock, Calculus of Consent](source-buchanan-tullock-calculus-consent-digest.md) | Constitutive-level rules governing risk regulation are where Sunstein's framework would anchor bounded governance. |
