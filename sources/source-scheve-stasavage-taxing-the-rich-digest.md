---
title: "Source Digest — Scheve & Stasavage, *Taxing the Rich* (2016)"
source_type: book_summary
source_title: "Taxing the Rich: A History of Fiscal Fairness in the United States and Europe"
source_author: "Kenneth Scheve and David Stasavage"
source_publication: "Princeton University Press (2016); summary via LSE Review of Books and IMF F&D"
source_date: 2016-03-01
source_url: "https://blogs.lse.ac.uk/lsereviewofbooks/2016/07/05/book-review-taxing-the-rich-a-history-of-fiscal-fairness-in-the-united-states-and-europe-by-kenneth-scheve-and-david-stasavage/"
source_url_secondary: "https://www.imf.org/external/pubs/ft/fandd/2016/06/book2.htm"
provenance: "collaborative"
viewpoint: "heterodox / political economy (moderate progressive)"
sub_debates: [2]
...
| Field | Value |
|---|---|
| **Authors** | Kenneth Scheve (Yale; political scientist) and David Stasavage (NYU; political scientist) |
| **Publisher** | Princeton University Press |
| **Free reviews** | [LSE Review of Books](https://blogs.lse.ac.uk/lsereviewofbooks/2016/07/05/book-review-taxing-the-rich-a-history-of-fiscal-fairness-in-the-united-states-and-europe-by-kenneth-scheve-and-david-stasavage/), [IMF Finance & Development](https://www.imf.org/external/pubs/ft/fandd/2016/06/book2.htm), [European Journal of Political Economy review](https://ejpe.org/journal/article/download/310/250/616) |
| **Companion article** | Scheve & Stasavage, ["War, Democracy, and Inequality" (2010), *APSR*](https://isps.yale.edu/news/blog/2012/11/scheve-and-stasavage-on-war-democracy-and-wealth-american-political-science-review) |
...
|---|---|---|
| Cross-national correlation between mass mobilization and top rates | **Corroborated** | The empirical work is rigorous and has been replicated. The correlational pattern is not in dispute; the causal interpretation is debated. |
| Compensatory logic as primary mechanism | **Partially corroborated** | Piketty, in *Capital and Ideology* (2020), offers an alternative account emphasizing ideological shifts after the world wars. The Cato review ([link](https://www.cato.org/cato-journal/winter-2018/taxing-rich-history-fiscal-fairness-united-states-europe-kenneth-scheve)) accepts the empirical pattern but challenges the normative interpretation. |
| Modern instruments face weaker fairness foundations | **Debated** | Normative rather than empirical; depends on one's theory of fairness. Scanlon (next digest) offers an alternative normative frame. |
...
|---|---|
| [Saez & Zucman, Progressive Wealth Taxation](source-saez-zucman-progressive-wealth-tax-digest.md) | Saez-Zucman's instrument design is a case study of a progressive proposal lacking the compensatory-norm scaffolding Scheve-Stasavage identifies as historically necessary. |
| [Cato, Taxing Wealth and Capital Income](source-cato-taxing-wealth-digest.md) | Approving Cato review shows that even libertarian readers accept the empirical pattern. |
| [Piketty, Capital in the Twenty-First Century](source-piketty-capital-21c-digest.md) | Alternative historical-political account; the Piketty-Scheve dispute over mechanism is productive to preserve. |
