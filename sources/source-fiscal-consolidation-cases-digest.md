---
title: "Source Digest — Democratic Fiscal Consolidation Cases: Canada 1990s, Sweden 1990s, New Zealand 1984–91"
source_type: comparative_historical_cluster
source_title: "Three Cases of Democratic Government Contraction from a High-Commitment Baseline"
source_author: "Multiple (IMF / OECD staff; academic political economy; Jenkins; Douglas; Lindbeck; Persson)"
source_publication: "Various"
source_date: 2010-01-01
source_url: "https://www.imf.org/en/Publications/fandd"
provenance: "ai-generated, steward-curated"
viewpoint: "comparative evidence against the universal-ratchet claim"
sub_debates: [1, 3, 5, 8]
copyright_notice: "IMF, OECD, and statistical-agency material is public. Academic excerpts are referenced for analytical commentary under fair use."
---

# Source Digest — Democratic Fiscal Consolidation Cases

> **Status (April 2026):** Complete standard digest. Three case studies in one document, each treated briefly, then a comparative section drawing the common pattern. Direct response to Exchange Question #4 on whether democracies have historically reduced government scope after major expansions. Pairs with the [Argentina / Milei digest](source-argentina-milei-reforms-digest.md) to give both historical and contemporary evidence.
...
| Field | Value |
|---|---|
| **New Zealand 1984–91** | Roger Douglas, *Unfinished Business* (1993); Brian Easton, *The Commercialisation of New Zealand* (1997); OECD Economic Surveys; [Wikipedia: Rogernomics](https://en.wikipedia.org/wiki/Rogernomics); [Wikipedia: Ruthanasia](https://en.wikipedia.org/wiki/Ruthanasia) |
| **Sweden 1991–98** | Lindbeck Commission Report (1993); Torben M. Andersen et al., *The Nordic Model* (2007); [IMF WP/00/69, Henriksson (2000)](https://www.imf.org/external/pubs/ft/wp/2000/wp0069.pdf); OECD Economic Surveys |
| **Canada 1993–97** | Paul Martin's 1995 budget; IMF Article IV reports; [Congressional Research Service — Canada fiscal consolidation](https://crsreports.congress.gov/); Jim Stanford, *Paper Boom* (1999); [OECD Economic Outlook historical series](https://www.oecd.org/economic-outlook/) |
...
|---|---|---|
| Three OECD democracies durably contracted government from high-expansion baselines | **Corroborated** | Standard OECD, IMF, academic record |
| Contraction required prior fiscal crisis or near-crisis conditions | **Corroborated** | All three cases |
| Fiscal rules institutionalized during or after contraction survived subsequent governments | **Corroborated** | Sweden (most clearly); Canada (to 2009); NZ (Fiscal Responsibility Act 1994 retained) |
| These cases are transferable to the U.S. fiscal position | **Debated** | U.S. fiscal position is strained but has not produced crisis-enabling conditions |
| The cases prove "welfare states are unsustainable" | **Not established** | Sweden preserved welfare universalism; Canada preserved Medicare; only NZ moved materially toward market-mediation, and that shift has been partially reversed |
...
|---|---|
| [Argentina under Milei](source-argentina-milei-reforms-digest.md) | Contemporary companion case |
| [Higgs, Crisis, Bigger Government](source-higgs-crisis-ratchet-digest.md) | Counterpoint: crisis produced contraction in these cases |
| [Swiss Debt Brake](source-swiss-debt-brake-digest.md) | Institutional kinship with Swedish expenditure ceiling |
| [OECD Fiscal Rules Database](source-oecd-fiscal-rules-digest.md) | Fiscal-rule framework under which Sweden's surplus target operates |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Sweden/Canada cases as models of capable state contraction |
