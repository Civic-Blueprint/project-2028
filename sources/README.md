...
This directory contains **source digests**: curated reference documents that capture, organize, and fact-check external source material relevant to Project 2028's analysis.
...
The project frequently encounters external analysis, commentary, and argument that intersects with its domains. Some of this material is rich enough to warrant systematic capture: the claims, the evidence cited, the rhetorical structure, and the fact-check status of specific assertions.
...
2. **Fact-checking.** Document the verification status of factual claims made in the source, with links to corroborating or contradicting evidence.
