---
title: "Source Digest — Cooperative Ownership: Mondragón, Worker Cooperatives, and Platform Cooperativism"
source_type: institutional_case_cluster
source_title: "Worker-Owned and Platform-Cooperative Forms as Alternative Ownership Architectures"
source_author: "Multiple (Mondragón Corporation; Ownership Economics at Rutgers; Virginie Pérotin; Nathan Schneider; Trebor Scholz)"
source_publication: "Various (academic political economy; cooperative-sector reports; Platform Cooperativism Consortium)"
source_date: 2018-06-01
source_url: "https://www.mondragon-corporation.com/en/"
source_url_secondary: "https://platform.coop/"
provenance: "ai-generated, steward-curated"
viewpoint: "empirical grounding for the 'transitional productive ownership' category in the Round 2 ownership taxonomy"
sub_debates: [2, 4]
copyright_notice: "Mondragón Corporation's public reporting is available. Academic and NGO excerpts are cited under fair use for analytical commentary."
---
...
| Field | Value |
|---|---|
| **Mondragón — primary** | [Mondragón Corporation website and annual reports](https://www.mondragon-corporation.com/en/); [Wikipedia: Mondragon Corporation](https://en.wikipedia.org/wiki/Mondragon_Corporation) |
| **Mondragón — academic** | William Foote Whyte and Kathleen King Whyte, *Making Mondragon* (Cornell ILR Press, 1991); Saioa Arando et al., "Assessing Mondragon: Stability and Managed Change in the Face of Globalization" (Journal of Business Ethics, 2011); Sharryn Kasmir, *The Myth of Mondragón* (SUNY Press, 1996) — critical account |
| **Worker-cooperative empirics** | [Virginie Pérotin, "What do we really know about worker co-operatives?" (2016)](https://www.uk.coop/sites/default/files/2020-10/worker_co-op_report.pdf); [Pérotin & Robinson (eds.), *Employee Participation, Firm Performance and Survival* (2004)](https://research.upjohn.org/up_bookchapters/); [NCEO data on ESOPs and worker ownership](https://www.nceo.org/) |
| **Platform cooperativism** | [Platform Cooperativism Consortium (The New School)](https://platform.coop/); Trebor Scholz, *Platform Cooperativism: Challenging the Corporate Sharing Economy* (Rosa Luxemburg Stiftung, 2016); Nathan Schneider, *Everything for Everyone: The Radical Tradition that Is Shaping the Next Economy* (Nation Books, 2018) |
| **Cross-cutting** | [International Cooperative Alliance — Cooperative Identity, Values, Principles](https://www.ica.coop/en/cooperatives/cooperative-identity); [World Cooperative Monitor reports (Euricse)](https://monitor.coop/) |
...
|---|---|---|
| Worker cooperatives can scale to tens of thousands of workers | **Corroborated** | Mondragón ~81K workers; Coop Italia, Legacoop federations |
| Worker cooperatives survive as long or longer than conventional firms | **Corroborated** | Pérotin review; multi-country empirical record |
| Cooperative financial infrastructure is decisive for scaling | **Corroborated** | Comparative country evidence strongly supports |
| Platform cooperativism has achieved mass displacement of conventional platforms | **Not established** | Some niche success; no dominant sector captured |
| Cooperative forms maintain their founding mission at scale without compromise | **Contested** | Mondragón two-tier workforce is the canonical counter-case |
...
|---|---|
| [Ostrom, Governing the Commons](source-ostrom-governing-commons-digest.md) | Conceptual kinship: cooperatives as common-property regimes with design principles analogous to Ostrom's |
| [Keynes, Economic Possibilities for Our Grandchildren](source-keynes-grandchildren-digest.md) | Transitional-ownership framing finds empirical grounding here |
| [Bastani, FALC](source-bastani-falc-digest.md) | Post-capitalist framing reads differently in light of existing cooperative scale |
| [Klein & Thompson, Abundance](source-klein-thompson-abundance-digest.md) | Cooperative forms as state-capacity-compatible ownership architecture |
| [Sovereign Wealth Funds](source-sovereign-wealth-funds-digest.md) | Companion: another hybrid ownership form addressing different problems |
