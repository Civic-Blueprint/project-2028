---
title: "Source Digest — Swiss Direct Democracy: Referendums, Initiatives, and the Entrenchment of Bounded-Governance Rules"
source_type: institutional_case_cluster
source_title: "Swiss Direct-Democratic Practice and Its Implications for Bounded-Governance Design"
source_author: "Multiple (Bruno S. Frey; Hanspeter Kriesi; Wolf Linder; Swiss Federal Chancellery)"
source_publication: "Various (academic political economy; Swiss government statistics)"
source_date: 2020-06-01
source_url: "https://www.bk.admin.ch/bk/en/home.html"
source_url_secondary: "https://www.c2d.ch/"
provenance: "ai-generated, steward-curated"
viewpoint: "institutional-design case study on how direct-democratic mechanisms anchor constitutive commitments"
sub_debates: [3, 8]
copyright_notice: "Swiss Federal Chancellery data is public. Academic excerpts are cited under fair use for analytical commentary."
---

# Source Digest — Swiss Direct Democracy
...
| Field | Value |
|---|---|
| **Primary institutional** | [Swiss Federal Chancellery (Bundeskanzlei)](https://www.bk.admin.ch/bk/en/home.html); [Swiss Federal Constitution, Art. 138–142 on direct-democratic rights](https://www.fedlex.admin.ch/eli/cc/1999/404/en) |
| **Data** | [Centre for Research on Direct Democracy (c2d)](https://www.c2d.ch/); [sudd.ch direct-democracy databases](https://sudd.ch/) |
| **Academic — Frey** | Bruno S. Frey, *Happiness and Economics* (Princeton, 2002); Frey & Stutzer, "Happiness, Economy, and Institutions" (*The Economic Journal*, 2000); Frey, "Direct Democracy: Politico-Economic Lessons from Swiss Experience" (*AER P&P*, 1994) |
| **Academic — Kriesi / Linder** | Hanspeter Kriesi and Alexander Trechsel, *The Politics of Switzerland* (Cambridge, 2008); Wolf Linder, *Swiss Democracy* (Palgrave, 3rd ed., 2010) |
| **Comparative analyses** | Gerber, *The Populist Paradox* (Princeton, 1999) on U.S. state-level direct democracy; Matsusaka, *For the Many or the Few* (Chicago, 2004) |
...
- **Approved:** constitutional creation of federal social insurance (1890s), women's suffrage (1971), UN membership (2002), invalidity insurance reforms, maternity leave (2004), [debt brake (2001, with 85% support)](source-swiss-debt-brake-digest.md).
...
|---|---|---|
| Swiss voters have voted on ~400 federal-level matters since 1874 | **Corroborated** | c2d and Federal Chancellery records |
| Direct-democratic cantons have lower deficits and taxes (controlling for other factors) | **Corroborated, with caveats** | Multiple Frey studies; replicated by later scholars; residual concern about omitted variables |
| Direct democracy increases tax morale | **Corroborated** | Frey; Torgler later work |
| Direct democracy enhances subjective well-being | **Contested** | Frey & Stutzer (2000) finding; replication mixed in other contexts |
| Swiss direct-democracy mechanisms are transferable to larger polities | **Debated** | Scale effects, federal diversity, and established institutional trust are significant confounders |
| Direct democracy protects minority rights | **Partially disconfirmed** | Minaret ban, Immigration Initiative cases illustrate concerns |

---

## Interpretive notes

- For the Round 2 bounded-governance design package, Swiss direct democracy is a specific instance of the *entrenchment* element. The [debt brake digest](source-swiss-debt-brake-digest.md) notes that the brake's constitutional entrenchment carries legitimacy because it was adopted by popular referendum (85% support). This is a particular kind of entrenchment distinct from supermajority-parliamentary or judicial entrenchment.
...
|---|---|
| [Swiss Debt Brake](source-swiss-debt-brake-digest.md) | The debt brake is the canonical instance of direct-democratic bounded-governance entrenchment |
| [Buchanan & Tullock, Calculus of Consent](source-buchanan-tullock-calculus-consent-digest.md) | Theoretical grounding: direct democracy as a constitutional-level choice mechanism |
| [Caplan, Myth of the Rational Voter](source-caplan-myth-rational-voter-digest.md) | Tension: Caplan argues direct democracy exacerbates voter-irrationality biases; Frey's empirics suggest Swiss experience is mixed |
| [Gilens & Page, Testing Theories of American Politics](source-gilens-page-testing-theories-digest.md) | Direct democracy partially overrides the elite-dominance pathway |
| [Ostrom, Governing the Commons](source-ostrom-governing-commons-digest.md) | Swiss polycentric federalism as context; Ostrom cites Swiss cases approvingly |
| [Rawls, Theory of Justice](source-rawls-theory-of-justice-digest.md) | Tension with Rawls's preference for constitutional constraints on majoritarian decisions |
