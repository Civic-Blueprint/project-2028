---
title: "Source Digest — Sachs, Andersen & others on the Nordic Model"
source_type: essay_and_working_paper
source_title: "The Social Conscience of the Nordic Countries (Jeffrey Sachs) + The Nordic Model — Embracing Globalization and Sharing Risks (Andersen et al., 2007)"
source_author: "Jeffrey Sachs; Torben M. Andersen, Bengt Holmström, Seppo Honkapohja, Sixten Korkman, Hans Tson Söderström, Juhana Vartiainen"
source_publication: "CEPR + ETLA (2007); ongoing Sachs commentary for World Happiness Report"
source_date: 2007-10-01
source_url: "https://www.etla.fi/wp-content/uploads/The-Nordic-Model-complete.pdf"
source_url_secondary: "https://worldhappiness.report/"
provenance: "collaborative"
viewpoint: "social-democratic / progressive comparative political economy"
sub_debates: [5]
copyright_notice: "Andersen et al. report is publicly available via ETLA. World Happiness Report is annually published free-access. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — The Nordic Model (Sachs + Andersen et al.)
...
| Field | Value |
|---|---|
| **Primary authors (2007 report)** | Torben M. Andersen, Bengt Holmström (Nobel 2016), Seppo Honkapohja, Sixten Korkman, Hans Tson Söderström, Juhana Vartiainen |
| **Primary report** | *The Nordic Model: Embracing Globalization and Sharing Risks*, ETLA/Taloustieto, 2007 |
| **Public URL** | [ETLA PDF](https://www.etla.fi/wp-content/uploads/The-Nordic-Model-complete.pdf) |
| **Ongoing statistical anchor** | [World Happiness Report](https://worldhappiness.report/) (Helliwell, Layard, Sachs, et al., annual) — Nordic countries have dominated the top of the rankings every year since inception |
...
|---|---|---|
| Nordic model combines high taxes with high economic performance | **Corroborated** | Standard finding across OECD, IMF, and academic literatures. |
| Risk-sharing sustains political support for openness | **Corroborated** | See [Rodrik, *Has Globalization Gone Too Far?*](https://www.piie.com/bookstore/has-globalization-gone-too-far) for the underlying theoretical argument. |
| Nordic outcomes are causally attributable to the specific model (rather than prior conditions) | **Partially corroborated** | Small, homogeneous populations, high baseline trust, and favorable initial conditions all played roles. Model is nonetheless robust to crisis tests (1990s banking crisis, 2008 GFC). |
| Model is exportable with adaptation | **Debated** | Strong-form exportability is contested; context-specific adaptation has worked in some cases. |
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Primary positive comparative case for Sub-debate 5.
- **Problem Map:** [Domain 10 (Wealth concentration)](../PROBLEM_MAP.md#10-wealth-and-power-are-concentrating-faster-than-governance-can-respond), [Domain 12 (Meaning of work)](../PROBLEM_MAP.md#12-work-and-purpose-are-decoupling-faster-than-our-institutions-can-absorb), [Domain 13 (Institutional capacity)](../PROBLEM_MAP.md#13-institutional-capacity-has-decayed-faster-than-the-problems-requiring-it).
- **Principles:** Positive existence proof for [Principle 1 (dignity is inherent and unconditional)](../PRINCIPLES.md#1-dignity-is-inherent-and-unconditional), [Principle 2 (essential needs should not be held hostage to avoidable scarcity)](../PRINCIPLES.md#2-essential-needs-should-not-be-held-hostage-to-avoidable-scarcity), [Principle 5 (critical systems require public-interest governance)](../PRINCIPLES.md#5-critical-systems-require-public-interest-governance), [Principle 7 (freedom requires both liberty and material stability)](../PRINCIPLES.md#7-freedom-requires-both-liberty-and-material-stability), and [Principle 4 (accountability, legibility, reversibility)](../PRINCIPLES.md#4-power-must-remain-accountable-legible-and-reversible). The Nordic model is unusually strong evidence for §7's positive-liberty position — that material stability is a constituent of freedom, not a competitor to it.
- **Round 2 use:** Primary citation for the "public-interest governance is empirically possible at scale" argument and for the openness-plus-risk-sharing synthesis.
...
|---|---|
| [Heritage/Fraser Economic Freedom Indexes](source-economic-freedom-index-digest.md) | Nordic countries' rankings on these indexes confirm the "high-tax with high institutional quality" configuration. |
| [Acemoglu & Robinson, Why Nations Fail](source-acemoglu-robinson-why-nations-fail-digest.md) | Nordic institutions are paradigmatic inclusive institutions. |
| [Lindert, Growing Public](source-lindert-growing-public-digest.md) | Provides the theoretical account of why the Nordic configuration works. |
| [Scheve & Stasavage, Taxing the Rich](source-scheve-stasavage-taxing-the-rich-digest.md) | Nordic tax-legitimation history is one of the cleanest cases of compensatory-theory dynamics. |
