---
title: "Source Digest — Rawls, *A Theory of Justice* (1971) and *Political Liberalism* (1993)"
source_type: philosophy_book_summary
source_title: "A Theory of Justice + Political Liberalism"
source_author: "John Rawls"
source_publication: "Harvard University Press (1971; rev. 1999; PL 1993)"
source_date: 1999-09-30
source_url: "https://plato.stanford.edu/entries/rawls/"
source_url_secondary: "https://www.hup.harvard.edu/books/9780674000780"
provenance: "collaborative"
viewpoint: "social-democratic / egalitarian liberal philosophical foundation"
sub_debates: [2, 8]
copyright_notice: "Stanford Encyclopedia of Philosophy entry is free; book pages are for reference. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — Rawls, *A Theory of Justice* and *Political Liberalism*
...
| Field | Value |
|---|---|
| **Author** | John Rawls (1921–2002; Harvard) |
| **Canonical works** | *A Theory of Justice* (Harvard UP, 1971; rev. 1999); *Political Liberalism* (Columbia UP, 1993) |
| **Freely available summary** | [Stanford Encyclopedia of Philosophy entry on John Rawls](https://plato.stanford.edu/entries/rawls/) (maintained by Leif Wenar) |
| **Related article** | [Rawls, "Justice as Fairness: A Restatement" excerpts](https://press.uchicago.edu/ucp/books/book/harvard/J/bo3635583.html) |
...
- Rawls argues that rational choosers behind the veil would converge on **two principles of justice** (in lexical priority order):
  ...
  2. **Two-part principle**:
     (a) **Fair equality of opportunity** — social and economic inequalities are attached to positions and offices open to all under conditions of fair equality of opportunity.
     (b) **Difference principle** — to the greatest benefit of the least-advantaged members of society.
...
|---|---|---|
| Original-position methodology | **Foundational** | Most influential single framework in late-20th-century political philosophy; extensively developed and critiqued. |
| Difference principle | **Contested** | Substantive egalitarian conclusion; critiqued by libertarians (Nozick), by critics of comprehensive liberalism (communitarians, Sandel), and by luck-egalitarians (who find it insufficiently egalitarian). |
| Public reason restriction | **Contested** | Has been critiqued by religious philosophers, communitarians, and by critics who argue it too narrowly restricts what can be argued in political debate. |
| Overlapping consensus is empirically possible | **Partially corroborated** | Stable constitutional democracies exhibit features Rawls describes; deeper pluralism (e.g., contemporary U.S. partisan polarization) tests the framework. |
...
- **Exchange:** [Government Overreach, Ownership as Transition, and the Ratchet Problem](../agent/exchanges/government-overreach-ownership-ratchet-exchange.md). Foundational philosophical source. Balances Nozick on Sub-debate 2; informs constitutive framing on Sub-debate 8.
- **Problem Map:** [Domain 10 (Wealth and power concentration)](../PROBLEM_MAP.md#10-wealth-and-power-are-concentrating-faster-than-governance-can-respond), [Domain 15 (Democratic process)](../PROBLEM_MAP.md#15-democratic-process-cannot-convert-public-need-into-institutional-action-at-the-speed-or-scale-required). Rawls is the philosophical scaffold the project's distributive arguments lean on whether or not they reach his conclusions: §10's concentration question and §15's "fair value of political liberty" subroutine are both Rawlsian framings.
- **Principles:** Directly supports [Principle 1 (dignity is inherent and unconditional)](../PRINCIPLES.md#1-dignity-is-inherent-and-unconditional) (basic-liberties priority and the equal-worth claim); [Principle 16 (justice mediates between competing claims)](../PRINCIPLES.md#16-justice-mediates-between-competing-claims) (the difference principle is one of the most developed answers to §16's "what to do when interests conflict" question, and Rawls's distinction between distributive and procedural justice is reflected directly in §16's text); [Principle 7 (freedom requires both liberty and material stability)](../PRINCIPLES.md#7-freedom-requires-both-liberty-and-material-stability) (fair equality of opportunity requires material conditions, not formal liberty alone); [Principle 4 (accountability, legibility, reversibility)](../PRINCIPLES.md#4-power-must-remain-accountable-legible-and-reversible) (public reason + constitutive-level entrenchment).
- **Round 2 use:** Primary philosophical anchor for the constitutive commitments on which bounded-governance design is built. Essential counterweight to Nozick.
...
|---|---|
| [Nozick, Anarchy, State, and Utopia](source-nozick-anarchy-state-utopia-digest.md) | Direct philosophical opposite on property and distribution. |
| [Scanlon, Why Does Inequality Matter?](source-scanlon-inequality-matter-digest.md) | Works within the Rawlsian tradition, developing pluralist objections to inequality. |
| [Buchanan & Tullock, Calculus of Consent](source-buchanan-tullock-calculus-consent-digest.md) | Methodologically parallel (constitutional choice from behind a veil) with different normative conclusions. |
| [Scheve & Stasavage, Taxing the Rich](source-scheve-stasavage-taxing-the-rich-digest.md) | Historical machinery through which Rawlsian distributive principles have actually been implemented. |
