---
title: "Source Digest — Sunset Clauses and Sunsetting Legislation Literature"
source_type: academic_article_and_report_cluster
source_title: "Sunset Clauses and Sunset Review: Theory, Evidence, and Practice"
source_author: "Baird & Gersen; Kysar; Mooney; Gersen; OECD; GAO"
source_publication: "Multiple"
source_date: 2007-03-01
source_url: "https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=2520&context=journal_articles"
source_url_secondary: "https://www.oecd.org/gov/regulatory-policy/oecd-reviews-of-regulatory-reform-regulatory-impact-analysis-9789264067110-en.htm"
provenance: "collaborative"
viewpoint: "institutionalist / bounded-governance design"
sub_debates: [8]
copyright_notice: "Law-review articles on sunset clauses are typically available via institutional repositories. Excerpts are included for analytical commentary under fair use."
---

# Source Digest — Sunset Clauses and Sunsetting Legislation
...
| Field | Value |
|---|---|
| **Canonical law-review article** | Jacob E. Gersen, "Temporary Legislation," *University of Chicago Law Review* 74, 2007 — [Chicago Unbound](https://chicagounbound.uchicago.edu/cgi/viewcontent.cgi?article=2520&context=journal_articles) |
| **Complementary treatment** | Rebecca M. Kysar, "The Sun Also Rises: The Political Economy of Sunset Provisions in the Tax Code," *Georgia Law Review* 40, 2006 |
| **Empirical surveys** | [OECD Regulatory Policy Outlook 2021](https://www.oecd.org/gov/regulatory-policy-outlook-2021.htm); [GAO reviews of federal sunset provisions](https://www.gao.gov/) |
| **State-level practice** | [NCSL overview of state sunset laws](https://www.ncsl.org/) |
...
|---|---|---|
| Sunsets invert status-quo advantage | **Corroborated theoretically** | Standard finding in political-economy literature. |
| Sunsets in practice achieve their intended effect | **Partially corroborated** | Strongly design-dependent. Most "routine" sunsets are extended pro-forma; substantive sunsets (with review bodies) can produce substantive change. |
| State-level sunset commissions work in some states | **Corroborated** | Texas sunset commission is widely studied as an effective implementation. |
| Crisis-era sunsets usually fail to prevent permanence | **Corroborated** | PATRIOT Act extensions, emergency-era tax provisions, and similar cases consistently show sunset-to-permanent drift. |
...
|---|---|
| [Swiss Debt Brake](source-swiss-debt-brake-digest.md) | The Swiss compensation account functions partly as a sunset-like device on emergency expenditures. |
| [OECD Fiscal Rules + IFIs](source-oecd-fiscal-rules-digest.md) | IFIs are the review infrastructure that make sunsets effective. |
| [Tax Policy Center, Tax Expenditures](source-tax-policy-center-tax-expenditures-digest.md) | Tax expenditures are a paradigmatic case where sunsets exist but don't function well. |
| [Buchanan & Tullock, Calculus of Consent](source-buchanan-tullock-calculus-consent-digest.md) | Sunsets are an operational-level mechanism that implements Buchanan's reversibility commitment. |
