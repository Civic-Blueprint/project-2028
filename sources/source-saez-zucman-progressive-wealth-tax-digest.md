---
title: "Source Digest — Saez & Zucman, \"Progressive Wealth Taxation\" (BPEA 2019)"
source_type: peer_reviewed_article
source_title: "Progressive Wealth Taxation"
source_author: "Emmanuel Saez and Gabriel Zucman"
source_publication: "Brookings Papers on Economic Activity (Fall 2019, pp. 437–533)"
source_date: 2019-09-01
source_url: "https://www.brookings.edu/articles/progressive-wealth-taxation/"
source_url_secondary: "https://gabriel-zucman.eu/files/SaezZucman2019BPEA.pdf"
...
| Field | Value |
|---|---|
| **Authors** | Emmanuel Saez (UC Berkeley) and Gabriel Zucman (UC Berkeley); both prominent public-finance economists and longtime collaborators on wealth-inequality measurement |
| **Venue** | *Brookings Papers on Economic Activity*, Fall 2019 |
| **URL (Brookings landing page)** | [brookings.edu/articles/progressive-wealth-taxation](https://www.brookings.edu/articles/progressive-wealth-taxation/) |
| **URL (author's archive)** | [gabriel-zucman.eu/files/SaezZucman2019BPEA.pdf](https://gabriel-zucman.eu/files/SaezZucman2019BPEA.pdf) |
| **Conference draft** | [Brookings-hosted PDF](https://www.brookings.edu/wp-content/uploads/2019/09/Saez-Zucman_conference-draft.pdf) |
| **Related** | [Saez-Zucman letter to Senator Warren](https://gabriel-zucman.eu/files/saez-zucman-wealthtax-warren.pdf) |
...
|---|---|---|
| ~1% of GDP revenue from a well-enforced U.S. wealth tax | **Debated** | Saez & Zucman estimate ~$2.75T over 10 years. Summers & Sarin (see forthcoming digest) estimate $0.4T–$1.0T under less-optimistic avoidance assumptions. Penn Wharton Budget Model estimates fall between. The range itself is informative — revenue potential depends sensitively on enforcement design. |
| European wealth taxes had broader bases and weaker enforcement | **Partially corroborated** | Confirmed by [OECD 2018 Net Wealth Tax study](https://www.oecd.org/tax/the-role-and-design-of-net-wealth-taxes-in-the-oecd-9789264290303-en.htm); most European wealth taxes applied at modest net-worth thresholds (~€500K–€1M), meaning a middle-class base with moderate revenue and disproportionate political visibility. |
...
|---|---|
| [Cato, Taxing Wealth and Capital Income](source-cato-taxing-wealth-digest.md) | Direct libertarian counterweight on administrative and European-experience grounds. |
| Forthcoming: Summers & Sarin, "A 'Wealth Tax' Presents a Revenue Estimation Puzzle" | Methodological middle-ground critique of Saez & Zucman's revenue estimate. |
| Forthcoming: Piketty, *Capital in the Twenty-First Century* | Broader empirical and theoretical frame on long-run capital accumulation. |
