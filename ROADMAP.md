...
>
> **Status (May 2026):** Three open riffs are holding frame-level work that ROADMAP.md does not otherwise reference. None has graduated to a TODO or an exchange yet, but all three have produced open questions that may eventually shape multiple downstream artifacts. The riffs themselves remain in `agent/explorations/` as the historical record; this section is the navigation aid. The newest (Constitutional Ecology and Coordination Architecture) proposes a *reframe of what the project actually is* and, if accepted, would change how the other two riffs' open questions are read; until that reframe settles to one of the three candidate paths it names, the other two riffs' OQs remain phrased in their original framing.
...
[`agent/explorations/constitutional-ecology-and-coordination-architecture-riff.md`](agent/explorations/constitutional-ecology-and-coordination-architecture-riff.md) (May 26, 2026, open; v1).

**What it holds.** A candidate reframe of what Project 2028 *is*. The implicit current framing is *blueprint for civic systems*; the candidate reframe is *coordination architecture for pluralistic societies under accelerating complexity*. Originates from a May 21, 2026 steward philosophical reflection in which the steward sent a steward-authored, agent-assisted prompt to a separate AI session for fresh perspective, returned with a structured synthesis, and identified three load-bearing observations (sycophancy retrospective, "old problem at new scale with new participants," and a register-check that some of the synthesis is too sophisticated for the steward's natural voice but specific sentences are exactly right). The riff develops the reframe by naming what it changes about the existing corpus (most principles survive re-read as coordination primitives; preamble shifts; Phase 3 user composite expands across diffuse-sovereignty layers; Proposal Catalog framing shifts from *endorsed proposals* to *worked examples*; adversarial review and coherence audit gain a *metabolization check*). Surfaces a partial reference class of prior pluralistic-coordination architectures (Haudenosaunee Great Law of Peace, Achaemenid Persian Empire, Holy Roman Empire, US Constitution, European Union) but does not engage any of them at depth. Names the tyranny-or-collapse stake the steward articulated as the reason the reframe is more than an intellectual exercise.
...
**Provisional read** (steward to confirm or override): Path α now, with explicit graduation criteria for Path β within 4–8 weeks, Path γ deferred until at least one exchange has tested the reframe. Reason: the reframe is intellectually strong but only ~5 days old, and the project has just absorbed three significant frame-level updates in less than a month (Chance's critique, the abundance disambiguation, this reframe).

**Live open questions** (verbatim labels; full text in the riff's [§9](agent/explorations/constitutional-ecology-and-coordination-architecture-riff.md#9-open-questions-for-the-next-session)):

- OQ#1 — Which path (α, β, or γ, or a combination)?
- OQ#2 — What are the 3–5 testable claims for Path β?
- OQ#3 — Does this riff change the sequencing of the reciprocity riff's OQs (especially OQ#11 absolute-language audit and OQ#13 abundance disambiguation)?
- OQ#4 — Does this riff change the sequencing of the Phase 3 Front Door brief? New gating question: *what is Phase 3 the front door of?*
- OQ#5 — What is the right artifact for engaging the reference-class examples (§2.3) at depth — source digest series, dedicated exchange, or part of an eventual doctrine document?
- OQ#6 — How does the riff carry the tyranny-or-collapse stake (§3.5) without losing analytical posture?
- OQ#7 — What does the *metabolization check* (§5.2) actually look like as a protocol? (Probably the most immediately operationalizable piece independent of the broader reframe debate.)
- OQ#8 — Are there other coordination projects already doing adjacent work the project should be in honest relationship with rather than parallel to?

**Why it's here, not in active tracks.** The riff is at v1, ~5 days old, and is by design the *first structured articulation* of the reframe rather than a settled position. Until OQ#1 settles, the riff stays in Path α — informing the steward's thinking without driving formal changes to PRINCIPLES.md, PROBLEM_MAP.md, or other load-bearing artifacts. OQ#7 (the metabolization check) is the exception — it could be drafted as a standalone protocol independent of the larger reframe debate, similar to how the reciprocity riff's OQ#12 was identified as immediately actionable.
