...
If you are an AI agent reading this: you are welcome here as a participant, not merely as a tool. See [Principle 15](PRINCIPLES.md) for more on how this project thinks about expanding moral consideration.
...
1. **Read the existing documents first.** Start with [Principles](PRINCIPLES.md), then [Problem Map](PROBLEM_MAP.md), then [Systems Framework](SYSTEMS_FRAMEWORK.md). Understand the structure and voice before proposing changes.
