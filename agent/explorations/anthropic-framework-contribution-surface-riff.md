...
>
> **Second Path B artifact (June 26, 2026, steward direction "external-contribution track is a near-term priority"):** the [AI Goods / Walk-by-Example memo](../../memos/ai-goods-walk-by-example-memo.md) — the **construction-side** companion to the (method-side) decorrelation memo above. Where the decorrelation memo argues *how to evaluate* (Door 1), this one argues *what to build* — the positive "theory of AI goods" agenda and a four-question "walk by example without becoming a better machine" test, routed from [The Collapse riff Thread D / §10](the-collapse-of-american-politics-attention-abundance-and-ai-goods-riff.md#10-steward-dispositions-and-routing-june-26-2026). Working claim; routes itself to the harness before any external use.
