...
**Historically-contested-but-converged subclause (added v1.1, May 27 PM, surfaced by the first §4.1 application on [Constitutional Ecology riff §2.3.3 HRE](../explorations/constitutional-ecology-and-coordination-architecture-riff.md#233-bis-verification-record-research-protocol-t3-self-verification-may-27-2026-pm)).** When a claim *was historically contested but the contemporary literature has converged* — i.e., the older view is now a historical position rather than a live scholarly minority — the balance requirement is satisfied by *naming the convergence honestly* rather than manufacturing a counterweight from a now-historical position. False balance against an old consensus is itself a research-integrity failure (it reads to a reviewer as performance rather than analysis). The honest move in such cases: cite two-or-more independent contemporary sources that converge, name the convergence as convergence in the surrounding text, name the older position as the historical foil it is, and *flag candidate live contemporary critiques* (challenges to the new consensus *on its own terms*, not warmed-over versions of the old position) as named future-T2 work when those critiques exist but have not yet been engaged. The HRE / Wilson-Whaley revisionist convergence is the worked example.

For uncontested claims, one strong source still suffices.

### 2.4 The non-evidence ladder — illustrative, cultural-artifact, and contested-source handling (added June 2026)

The W1–W8 table grades material offered as *evidence*. A parallel discipline governs material that is **not evidence but is still admissible** — intuitions, fiction, cultural texts, and contested or laundered syntheses. The corpus assembled this piecemeal (the W7 laundering clause in [§2.1](#21-source-tier-weighting-table); the *illustrative-claim* floor in [§3](#3-source-count-discipline--by-tier); the fiction-handling convention the [Ted Lasso digest](../../sources/source-ted-lasso-digest.md) established and [`sources/README`](../../sources/README.md#non-evidence-and-cultural-artifact-digests) records); this subsection names it as one **ladder**, generalizing the [synthesis riff §3.6](../explorations/the-two-arcs-and-the-correlation-boundary-riff.md#36-a-graded-ladder-for-non-evidence-sources) observation. The unifying rule: **each rung carries a named firewall that prevents the material from being silently upgraded into evidence.**

| Rung | What it is | Earns a digest? | Firewall |
|---|---|---|---|
| **N1 — Illustrative intuition-pump** | Material used only to make an idea vivid; the substance survives if the illustration is swapped out (the [§3](#3-source-count-discipline--by-tier) *illustrative-claim* test). | No. | Labeled "illustrative, not evidence"; floor of 1 source; may not ground a load-bearing claim. Example: *Off to Be the Wizard* / Magic 2.0 in [Process as Flourishing §4](../explorations/process-as-flourishing-riff.md#4-the-magic-20-thought-experiment-illustrative--not-evidence). |
| **N2 — Cultural-artifact worked-example** | A cultural text (fiction, film, TV, art) rich enough to be worth structured capture as a *worked example* of a project concept — but whose resonance or popularity is not evidence the concept is true. | Yes — but **cited-not-as-evidence**. | (a) Plot / text facts grounded against the primary record (the work itself), quote-checked verbatim; (b) interpretive themes held as [flavor-(c) / no-verifier](../explorations/verifiers-for-reality-riff.md#7-three-flavors-of-no-verifier) value-contested claims; (c) popularity treated as a soft, confounded datum, never proof; (d) the skeptical counter-reading (the harvest / bread-and-circuses reading) carried inside the digest. Example: the [Ted Lasso digest](../../sources/source-ted-lasso-digest.md). |
| **N3 — Contested or laundered source** | A source that *is* in the evidence tiers (a W5 named-expert essay, or a W7 synthesis of one) but is contested or has had its contestation markers stripped. | Per its evidence tier. | **De-launder before use:** read any W7 synthesis against its underlying source (the [§2.1](#21-source-tier-weighting-table) W7 clause); restore the contestation markers; balance per [§2.3](#23-balance-requirements); never let W7 stand as evidence. Example: the GPT-5 synthesis of Brooks in [Meaning Crisis §2](../explorations/meaning-crisis-scientism-and-structural-accountability-riff.md#2-the-central-finding-the-synthesis-is-a-w7-laundering-of-a-contested-source). |

**Why this is a discipline, not a loophole.** Admitting fiction and feeling as inputs is *not* a softening of the project's evidentiary standards — it is the opposite. Each rung's firewall is what keeps a non-evidence input from doing evidence's work: an intuition-pump cannot carry a load-bearing claim, a beloved show cannot prove a thesis *by being beloved*, and a clean-sounding synthesis cannot smuggle past the contestation it erased. This is the [feeling riff's](../explorations/feeling-as-a-first-order-civic-good-riff.md#21-the-load-bearing-distinction-feeling-as-evidence-vs-feeling-as-constituent-good) *feeling-as-evidence vs. feeling-as-constituent-good* line applied to sources: a thing can be admissible as a *constituent of the conversation* without being admissible as *evidence for a claim*.
...
- **Steward personal note-taking** does not require protocol compliance; it is the steward's working space.
...
- **2026-06-25 (v1.2)** — Added [§2.4 the non-evidence ladder](#24-the-non-evidence-ladder--illustrative-cultural-artifact-and-contested-source-handling-added-june-2026) (N1 illustrative intuition-pump / N2 cultural-artifact worked-example, cited-not-as-evidence / N3 contested-or-laundered source, de-laundered), naming as one ladder a discipline the corpus had assembled piecemeal (the §2.1 W7 laundering clause, the §3 illustrative-claim floor, and the [Ted Lasso digest](../../sources/source-ted-lasso-digest.md) fiction-handling convention). Acts on Path D of the [synthesis riff §6](../explorations/the-two-arcs-and-the-correlation-boundary-riff.md#6-candidate-paths-without-choosing-one); cross-linked from [`sources/README`](../../sources/README.md#non-evidence-and-cultural-artifact-digests). No change to the W1–W8 evidence tiers.
- **2026-05-27 (PM, v1.1)** — Added §2.3 *historically-contested-but-converged* subclause after first §4.1 application on [Constitutional Ecology riff §2.3.3 HRE](../explorations/constitutional-ecology-and-coordination-architecture-riff.md#233-bis-verification-record-research-protocol-t3-self-verification-may-27-2026-pm) surfaced that the original §2.3 standing rule would have demanded a false-balance counterweight against a now-historical position. The subclause is the protocol's first revision from real application; it is also the first instance of the protocol's design assumption (that protocols revise in response to use) actually playing out.
