...
The practitioner saw *something* — but the steward did not document which surface (homepage, memo, a specific document) was shared, or whether the link landed on a Hero with orientation context or skipped past it (the failure mode named in [Exchange #17 Round 1, point 2a](first-practitioner-critique-ai-provenance-exchange.md#round-1)). Diagnosing "the writing is too dense" is premature if the entry path was wrong. The exchange should explicitly flag this gap and consider whether a re-engagement protocol can disambiguate.
