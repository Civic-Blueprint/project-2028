...
| **Round 2 (June 26, 2026)** | Cross-lineage adversarial run under the [Cross-Lineage Review Harness](../process/cross-lineage-review-harness-protocol.md): four blind independent-lineage reviewers (Gemini see-side, Kimi belong-side, Grok adversary, GPT-5.5 verifier) + a labeled same-lineage Claude control. **Claim set does not survive as written** — BLOCKING on **C2 (separability collapses to a gradient — the pre-registered crux)** and **C4 (unification is a redescription of conflict-of-interest + Goodhart)**, plus C1 (see-side overclaims a conditional theorem; belong-side "creed = belonging" unfalsifiable) and C3 (fourth-function not established). Recommended disposition **HOLD / REVISE** (steward disposes). Reflexively answers riff [Q6](../explorations/the-two-arcs-and-the-correlation-boundary-riff.md#7-open-questions): a measured same-lineage severity gap (9 independent BLOCKING vs. ~1 control) + the "correlation is a homonym" catch point to the two-arcs structure being **substantially a reading artifact** → the riff's fold-not-patch clause is now live. |
| **Status** | Active; Round 2 complete; Rounds 3–N reserved. |

---

### 33. [Collective Emotional Ritual — Civic Good or Bread-and-Circuses? — Exchange](collective-emotional-ritual-civic-good-exchange.md)

|  |  |
| --- | --- |
| **Question** | Is collective emotional ritual (fandom, sport, shared spectacle) a first-order civic good and a real instance of un-metabolized [Principle 13](../../PRINCIPLES.md#13-pluralism-and-self-determination-are-strengths-not-obstacles) coexistence — or depoliticizing distraction? Specifically: can "does collective ritual **channel into** vs. **drain** civic agency" be tested with a *portable* predictor (the gate), is the intrinsic-good claim cite-only or adoptable, and can the harvest discipline ("carry both thoughts") be built into an institution? |
| **Depends on** | [Feeling as a First-Order Civic Good riff §6 / §2.1 / §4](../explorations/feeling-as-a-first-order-civic-good-riff.md#6-the-genuinely-testable-question) (source + the load-bearing distinction + the harvest discipline), [World Cup digest](../../sources/source-weekly-show-stewart-world-cup-digest.md) + [Ted Lasso digest](../../sources/source-ted-lasso-digest.md) (worked examples, illustration-not-evidence; 1978 Argentina harvest guard), [Brooks digest](../../sources/source-modern-wisdom-1109-brooks-digest.md) + [Meaning Crisis riff §3](../explorations/meaning-crisis-scientism-and-structural-accountability-riff.md#3-the-structural-collision-anti-structural-individualism-vs-principle-2) (counter-anchor), Durkheim/Turner/Collins (un-grounded; T2 owed), [#29](principle-2-solvable-vs-perennial-boundary-exchange.md) (general belonging-as-good, not duplicated) + [#30](demand-side-misinformation-meaning-deficit-exchange.md) (harvested-meaning sibling) + [#32](decorrelate-to-see-correlate-to-belong-exchange.md) (the folded synthesis this is the surviving fragment of), [Collapse Thread C census](../explorations/the-collapse-of-american-politics-attention-abundance-and-ai-goods-riff.md#4-thread-c--phase-3-as-a-flourishing-definition-census-in-honor-of-principle-13) (downstream object), Principles §1/§13/§14 + Problem Map, Adversarial Review + Cross-Lineage Harness + Research Protocol §2.3. |
| **Produced** | Round 1 states the falsifiable claim set **E33-C1…C5** (C1 two separable registers of collective feeling; C2 intrinsic-good is value-contested / cite-only; C3 channels-vs-drains is a portable falsifiable edge — **the gate**; C4 harvest discipline is mandatory + partly observable; C5 only a *structural-protection* claim is adoptable, gated, no #29 duplication) + an Option A/B/C adversary packet. **Round 2 ran the cross-lineage adversarial pass (June 26, 2026)** — Gemini (sport/ritual sociology), GPT-5.5 (participation empiricist / the gate), Kimi (blind adversary), Grok (balanced-sourcing verifier + Durkheim/Turner/Collins grounding), synthesized by a non-author Gemini. **Outcome: the claim set does NOT survive as written.** The pre-registered **C3 gate failed across all four lineages** (no portable channel-vs-drain predictor; the literature is case-bound), cross-stance; BLOCKING also stands on **C1** (separability — the same move that failed in [#32](decorrelate-to-see-correlate-to-belong-exchange.md)) and **C4** (authentic-vs-manufactured is circular). **C2** (cite-don't-adopt) is the only durable fragment — and by its own falsification condition "adds nothing to [#29](principle-2-solvable-vs-perennial-boundary-exchange.md)." Two lineages independently converged on a salvage reframe (*who controls the ritual infrastructure* → routes to [P14](../../PRINCIPLES.md#14-truth-and-evidence-must-be-protected-as-public-goods) / #30, not a new program). Recommended disposition **HOLD / REVISE**; the [convergence guard](collective-emotional-ritual-civic-good-exchange.md#convergence-guard-read-first) ("better-supported than the architecture" ≠ "supported") is vindicated. Steward go/no-go pending; not human-reviewed; non-evidence for any core-document edit. |
| **Status** | Active; Round 2 complete; Rounds 3–N reserved. |
  ...
  Exploration: The Two Arcs and the Correlation Boundary Riff (synthesis/meta)
        ...
        └─► #32 Decorrelate-to-See vs. Correlate-to-Belong — Exchange
              ...
              (Round 1 claims E32-C1…C5: two-valence defect/good; layers separable [crux];
               ...
               disposition. Round 2 RUN June 26 2026 — claim set does NOT survive: BLOCKING on
               C2 [separability→gradient] + C4 [redescription], plus C1 & C3; HOLD/REVISE pending
               steward. Q6 result: two-arcs structure substantially a reading artifact → fold-not-patch live)

  Exploration: Feeling as a First-Order Civic Good Riff
        │  (Source Digests: Weekly Show World Cup + Ted Lasso; counter-anchor: Brooks)
        │
        └─► #33 Collective Emotional Ritual — Civic Good or Bread-and-Circuses?
              ◄── Feeling riff §6 (testable question) + §2.1 (feeling-as-evidence vs. constituent-good) + §4 (harvest)
              ◄── World Cup / Ted Lasso digests (illustration-not-evidence; 1978 Argentina guard)
              ◄── Brooks digest + Meaning Crisis §3 (counter-anchor) + Durkheim/Turner/Collins (T2 owed)
              ◄── #29 (general belonging-as-good, not duplicated) + #30 (harvested-meaning sibling)
              ◄── #32 (folded synthesis; this is the surviving fragment — convergence guard carries over)
              ──► Collapse Thread C census (hands down "capture affect, not just propositions")
              ◄── Principles §1/§13/§14 + Problem Map (no meaning/feeling domain — candidate finding)
              ◄── Adversarial Review + Cross-Lineage Harness + Research Protocol (T2 two-sided)
              (Round 1 claims E33-C1…C5: two registers; intrinsic-good cite-only; channels-vs-drains
               portable falsifiable edge [the gate, C3]; harvest discipline; structural-protection-only
               disposition. Adversarial Round 2 reserved — adversary rotated off Grok; opens on C3)
```
