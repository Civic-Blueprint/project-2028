...
> **Status (April 2026):** Round 2 complete. Round 1 reframed the F1 task and reproduced the v2 text under review; Round 2 applied the [Adversarial Review Protocol](../process/adversarial-review-protocol.md) under Option A (reduced context) plus Option C (public-administration / heterogeneous-polity failure lens). Rounds 3–5 remain reserved. This exchange is the F1 follow-up to [Exchange #21 (Government Overreach, Ownership as Transition, and the Ratchet Problem)](government-overreach-ownership-ratchet-exchange.md), spawned per [ROADMAP TODO #1](../../ROADMAP.md). It runs adversarial review + an external human reviewer round + steward voice edit on the [v2 Principle 5 text](government-overreach-ownership-ratchet-exchange.md#deliverable-1--revised-principle-5-text-v2) produced in Exchange #21 Round 5, and integrates the result into [PRINCIPLES.md §5](../../PRINCIPLES.md#5-critical-systems-require-public-interest-governance) and [FOUNDATIONAL_COMMITMENTS.md §5](../../FOUNDATIONAL_COMMITMENTS.md#5-critical-systems-require-inclusive-institutions-with-bounded-rules).
>
> **Why this exchange:** Exchange #21 is closed at Round 5. Its v2 Principle 5 deliverable currently lives only in the exchange document and in [FOUNDATIONAL_COMMITMENTS.md §5](../../FOUNDATIONAL_COMMITMENTS.md#5-critical-systems-require-inclusive-institutions-with-bounded-rules); [PRINCIPLES.md §5](../../PRINCIPLES.md#5-critical-systems-require-public-interest-governance) still carries the pre-#21 short text. The two §5s now disagree on title and substance — flagged as finding P2-2 in the [April 2026 Coherence Audit Pass 2](../process/audits/coherence-audit-2026-04.md#pass-2--problem_mapmd-hallucinations-and-principlesmd--foundational_commitmentsmd-5-drift) and gated on this exchange. Independently, Exchange #21 Round 5 explicitly recorded "no external human reviewer participated" as the largest residual structural gap and conditioned the F1–F6 follow-ups on closing it. F1 is the smallest, highest-structural-priority follow-up: it reconciles the §5 drift, runs the missing external-review round, and produces a v3 text suitable for direct integration into the principles document.
>
...
| Type | Document |
|---|---|
| **Source exchange** | [Exchange #21 — Government Overreach, Ownership as Transition, and the Ratchet Problem](government-overreach-ownership-ratchet-exchange.md), specifically [Round 5 Deliverable 1 (v2)](government-overreach-ownership-ratchet-exchange.md#deliverable-1--revised-principle-5-text-v2) — the input under review. |
| **Core documents** | [PRINCIPLES.md §5 (current text)](../../PRINCIPLES.md#5-critical-systems-require-public-interest-governance), [FOUNDATIONAL_COMMITMENTS.md §5 (v2-derived)](../../FOUNDATIONAL_COMMITMENTS.md#5-critical-systems-require-inclusive-institutions-with-bounded-rules), [PROBLEM_MAP.md](../../PROBLEM_MAP.md) (Domains 4, 13, 15) |
| **Audit anchor** | [April 2026 Coherence Audit — Pass 2 (finding P2-2 in the table)](../process/audits/coherence-audit-2026-04.md#pass-2--problem_mapmd-hallucinations-and-principlesmd--foundational_commitmentsmd-5-drift) (drift between PRINCIPLES.md §5 and FOUNDATIONAL_COMMITMENTS.md §5; gated on this exchange) |
| **Protocols and packet** | [Adversarial Review Protocol](../process/adversarial-review-protocol.md), [Reviewer Packet Template](../../docs/REVIEWER_PACKET_TEMPLATE.md), [Reviewer-as-a-Round Convention](../../docs/REVIEWER_AS_A_ROUND_CONVENTION.md) |
| **Roadmap commitments** | [ROADMAP TODO #1 (F1 spawn decision)](../../ROADMAP.md), [TODO #9 (TR1 transferability + perspective-gap research)](../../ROADMAP.md), [TODO #10 (TR2 external human reviewer commitment)](../../ROADMAP.md), [TODO #11 (first live reviewer recruited under packet)](../../ROADMAP.md) |
| **Phase 3 dependency** | [Phase 3 Front Door Riff](../explorations/phase-3-front-door-riff.md) — the riff currently waits on this exchange for §5 vocabulary reconciliation per steward decision (Option 1). |
...
The text below is reproduced verbatim from [Exchange #21 Round 5 Deliverable 1 (v2)](government-overreach-ownership-ratchet-exchange.md#deliverable-1--revised-principle-5-text-v2). This is the input F1 operates on. Subsequent rounds may propose changes; the input itself is not edited inside this exchange.
...
The v2 text was produced in Exchange #21 Round 5 as integration of the ten clear adversarial wins and two partial wins from Round 4. The Round 4 adversarial pass (per the [Adversarial Review Protocol](../process/adversarial-review-protocol.md), Options B + C) attacked the v1 text on four major axes:
...
[PRINCIPLES.md §5](../../PRINCIPLES.md#5-critical-systems-require-public-interest-governance) currently reads (title and substance):
...
[FOUNDATIONAL_COMMITMENTS.md §5](../../FOUNDATIONAL_COMMITMENTS.md#5-critical-systems-require-inclusive-institutions-with-bounded-rules) is titled "Critical systems require inclusive institutions with bounded rules" and elaborates the v2 text into operational commitment language (five demonstrably-present conditions, mechanism requirements).
...
|---|---|---|---|
| 1 (this round) | Reframe and inputs | Exchange #21 Round 5 v2 text; the §5 drift; the F1 mandate from ROADMAP TODO #1 | This document — input under review, what it responds to, drift to resolve, plan for Rounds 2–5 |
| 2 | Adversarial pass | The v2 text (no full Exchange #21 thread); domain-specific lens (see §1.5 below); the four Round 4 axes from §1.2 above as "previously contested" claims | Adversarial findings, with epistemic status table per [Adversarial Review Protocol §3](../process/adversarial-review-protocol.md) |
| 3 (reserved) | External review | Reviewer Packet sent to one external human reviewer; review type chosen per §1.6 below | Reviewer's verbatim contribution, integrated as Round 3 per [Reviewer-as-a-Round Convention §1](../../docs/REVIEWER_AS_A_ROUND_CONVENTION.md) |
| 4 (reserved) | Response round | Round 2 adversarial findings + Round 3 reviewer contribution | v3 text of Principle 5; clause-by-clause changelog tying each change to a specific finding; research-debt entries for non-integrable findings |
| 5 (reserved) | Steward voice edit + integration | v3 text from Round 4; steward voice pass | Final §5 text in PRINCIPLES.md; FOUNDATIONAL_COMMITMENTS.md §5 reconciled at the same commit; ROADMAP F1 marked complete; coherence audit P2-2 closed |

### 1.5 Adversarial pass parameters (Round 2, reserved)

Per the [Adversarial Review Protocol](../process/adversarial-review-protocol.md):
...
Per the [Reviewer Packet Template](../../docs/REVIEWER_PACKET_TEMPLATE.md) and [Reviewer-as-a-Round Convention](../../docs/REVIEWER_AS_A_ROUND_CONVENTION.md):
...
This round applies the [Adversarial Review Protocol](../process/adversarial-review-protocol.md) to the v2 Principle 5 text. It intentionally does **not** continue the constructive integration posture of Exchange #21. Its job is to find what the v2 text still gets wrong, hides, overclaims, or leaves unusable.

Per [§1.5](#15-adversarial-pass-parameters-round-2-reserved), this review uses:

- **Option A — reduced context.** The reviewed object is the v2 text in [§1.1](#11-the-input-under-review-verbatim), the four prior challenge axes in [§1.2](#12-what-this-text-is-responding-to), the current §5 drift in [§1.3](#13-the-5-drift-this-exchange-resolves), and the standing questions in the [Adversarial Review Protocol](../process/adversarial-review-protocol.md#5-standing-questions-for-all-reviewers). This round does not rely on the full Exchange #21 narrative arc.
...
### 2.5 Recommended constraints for v3
...
|---|---|---|---|
| The v2 text is substantively stronger than current `PRINCIPLES.md §5` | Working hypothesis | It defines "public interest" through inclusive/bounded governance, addresses ownership/governance interaction, and names reference-class limits absent from the current text | External reviewer argues the current shorter §5 is more durable and that v2's added doctrine creates more confusion than constraint |
| The inclusive/bounded pair should remain the core of v3 | Working hypothesis | It directly answers the ratchet problem and avoids state-vs-market simplification | Reviewer shows the pair is unintelligible or politically unusable outside project context; or identifies a superior formulation that preserves the same constraint |
| The v2 text overburdens `PRINCIPLES.md` with doctrine material | Working hypothesis | Tradition genealogy, form-list, ownership taxonomy implications, and reference-class discussion are all present in the principle text itself | Steward decides that principles should be doctrine-dense; or reviewer finds that the added specificity is necessary for trust and not an obstacle |
| Reference-class limitation must become an operational constraint | Working hypothesis | A caveat without consequences can be cited while ignored; public-administration failure often occurs through nominal adoption of forms without conditions | Reviewer argues the principle should not carry procedural constraints and that FC §5 / F3 should carry all transferability discipline |
| The form-list should be shortened or moved out of the principle | Working hypothesis | Lists of respected forms can be mistaken for validation; each listed form can fail inclusiveness or boundedness | Reviewer finds that examples are necessary for legibility and that absence of examples makes the principle too abstract |
| The ownership-governance paragraph should be generalized | Working hypothesis | Ownership is one power-structure variable among several; overemphasis may privilege Exchange #21's frame beyond its evidence | Reviewer or steward concludes ownership concentration is sufficiently central across critical systems to deserve named principle-level treatment |
| F1 should not close until Round 3 external review is integrated | Established by process | ROADMAP TR2 and this exchange's own round plan require one external human reviewer before integration | Steward explicitly relaxes TR2, which would require ROADMAP and exchange-status changes |

### 2.7 Open issues after Round 2

| # | Issue | Owner | What's needed |
|---|---|---|---|
| F1-R2-1 | Artifact-boundary rule before v3 drafting | Round 4 agents + steward | Decide how much material belongs in `PRINCIPLES.md` versus `FOUNDATIONAL_COMMITMENTS.md` versus F3 doctrine before drafting v3. |
| F1-R2-2 | Operational transferability constraint | Round 4 agents + external reviewer | Convert the reference-class limitation into a constraint on future claims/proposals, or explicitly assign that constraint to FC §5 / F3. |
| F1-R2-3 | Inclusive/bounded conflict handling | Round 4 agents + external reviewer | Name how proposals should handle cases where broad participation and bounded authority pull against each other. |
| F1-R2-4 | Anti-theater standard | Round 4 agents + external reviewer | Decide whether v3 should include a compact clause that formal oversight, review, transparency, or participation only counts if it can alter outcomes. |
| F1-R2-5 | Reviewer standpoint selection | Steward | Round 3 remains blocked on selecting the external reviewer and review type. Round 2 suggests a reviewer who can test audience portability or hollow-adoption risk would now be especially valuable. |

---

## Round 3 — External review (reserved)

To be populated when the recruited reviewer's contribution arrives, per [§1.6](#16-external-review-parameters-round-3-reserved) and the [Reviewer-as-a-Round Convention §1](../../docs/REVIEWER_AS_A_ROUND_CONVENTION.md).

---

## Round 4 — Response round (reserved)

To be drafted per [Reviewer-as-a-Round Convention §3](../../docs/REVIEWER_AS_A_ROUND_CONVENTION.md). Output: v3 text of Principle 5, clause-by-clause changelog, research-debt entries, deferred-finding list.

---

## Round 5 — Steward voice edit + integration (reserved)

Steward applies a voice pass to the v3 text. Output: final §5 text. The same commit reconciles FOUNDATIONAL_COMMITMENTS.md §5 with PRINCIPLES.md §5. ROADMAP F1 is marked complete. Coherence audit finding P2-2 (recorded in the [Pass 2 section](../process/audits/coherence-audit-2026-04.md#pass-2--problem_mapmd-hallucinations-and-principlesmd--foundational_commitmentsmd-5-drift)) is closed.
...
| # | Issue | Owner | What's needed |
|---|---|---|---|
| F1-O1 | Review-type selection (Round 3) | Steward | **Provisional selection made for first candidate:** perspective-gap + audience-portability review. Confirm after the call whether this is the reviewer and review type to use for Round 3. |
| F1-O2 | External reviewer recruitment | Steward | Candidate identified: politically engaged, historically literate, community-rooted reviewer with limited prior Project 2028 context. Packet prepared; recruitment remains open until the reviewer accepts and submits a response. |
| F1-O3 | Round 3 complementarity with Round 2 | Agents (after F1-O2) | Current packet is tuned to test audience portability and perspective gaps, deliberately complementing Round 2's public-administration / hollow-adoption lens rather than duplicating it. Revisit only if reviewer fit changes. |
| F1-O4 | Phase 3 brief sequencing | Steward | The [Phase 3 Front Door Riff](../explorations/phase-3-front-door-riff.md) currently waits on F1's v3 text per the steward's Option 1 decision. Phase 3 brief drafting begins after F1 closes. |
| F1-O5 | Artifact-boundary rule | Round 4 agents + steward | Before drafting v3, decide what belongs in `PRINCIPLES.md §5` versus `FOUNDATIONAL_COMMITMENTS.md §5` versus F3 doctrine. Round 2 argues this is the hidden upstream decision. |
| F1-O6 | Operational transferability constraint | Round 4 agents + external reviewer | Decide whether the reference-class limitation becomes a principle-level constraint, a FC §5 mechanism requirement, or F3 research debt. Round 2 argues a caveat without consequences is too weak. |
| F1-O7 | Anti-theater clause | Round 4 agents + external reviewer | Decide whether v3 should include a compact clause that formal oversight, transparency, participation, or review only counts if it can alter outcomes. |
...
| Claim | Confidence | Basis | What would change this assessment |
|---|---|---|---|
| The v2 text is the correct base for Principle 5 revision | Working hypothesis | Exchange #21 Rounds 1–5 produced it under the Adversarial Review Protocol; Round 2 finds v2 substantively stronger than current `PRINCIPLES.md §5`, but not integration-ready without boundary decisions | External reviewer argues the current shorter §5 is more durable; or Round 4 finds the v2 frame structurally wrong rather than locally overburdened |
| Adversarial pass + one external human reviewer is sufficient before integration into PRINCIPLES.md | Working hypothesis | ROADMAP TR2 (#10) commits to this configuration for F1; Round 2 surfaced concrete issues that Round 3 can test rather than reopening the whole exchange | First-use experience showing the configuration produces incoherent or unintegrable output; or reviewer surfaces a legitimacy failure that requires broader review |
| The Round 2 lens (bounded-governance failure in heterogeneous polities) was productive | Working hypothesis | Round 2 converted the reference-class caveat into a concrete operational-constraint problem and surfaced hollow-adoption risk | Reviewer shows the main risk is not transferability / hollow adoption but something else, such as audience trust, ideological framing, or practical feasibility |
| Round 5 voice edit will not require re-opening Rounds 2–4 | Speculative | Standard cadence for principle revisions, but F1 is the first to integrate an external review round | Voice editing reveals substantive issues the prior rounds missed; would require a Round 5a return to Round 4 |
| v3 should be shorter and more modular than v2 | Working hypothesis | Round 2 finds v2 overburdens `PRINCIPLES.md` with doctrine, examples, intellectual genealogy, and research debt | Steward decides principle sections should be doctrine-dense; or reviewer finds specificity increases trust more than it harms portability |
...
- **Steward decisions captured in this round:**
  ...
  - Phase 3 front door waits for F1 (Option 1 from the [Phase 3 Front Door Riff §3.3 decision discussion](../explorations/phase-3-front-door-riff.md)).
  - Open issues F1-O1 and F1-O2 are steward-owned and remain unfilled after Round 2.
- **Round 2 adversarial contributor:** Composer 1 (April 30, 2026), applying [Adversarial Review Protocol](../process/adversarial-review-protocol.md) Option A + Option C under the public-administration / heterogeneous-polity failure lens reserved in Round 1.
