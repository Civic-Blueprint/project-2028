...
- **Intake / triage context:** [Website Submission Triage Checklist](../../WEBSITE_SUBMISSION_TRIAGE_CHECKLIST.md), GitHub issue [#10](https://github.com/Civic-Blueprint/project-2028/issues/10)
- **Source digests:** [Stewart, Acemoglu & Autor — *AI & The Future of Work*](../../sources/source-weekly-show-stewart-ai-future-of-work-digest.md) — primary external evidence base for Round 1; provides the pro-worker AI direction-of-technology framing, the data-extraction-economy critique, and a concrete commonwealth-style policy package (UBC, labor/capital tax rebalance, pro-worker R&D funding, wage insurance). Adjacent: [AI Governance Practice digest](../../sources/source-ai-governance-practice-digest.md) for the regulatory-record evidence base.
...
Issue [#10](https://github.com/Civic-Blueprint/project-2028/issues/10) makes three consequential claims:
...
**Primary: [Stewart, Acemoglu & Autor — *AI & The Future of Work*](../../sources/source-weekly-show-stewart-ai-future-of-work-digest.md)** (April 22, 2026 podcast, 9 thematic clusters, fully fact-contextualized). Directly relevant material includes:

- **Cluster 4 (Pro-worker AI as a directional commitment)** — Acemoglu, Autor, and Simon Johnson have a published research program ([Hamilton Project, 2025](https://www.hamiltonproject.org/publication/paper/building-pro-worker-ai/)) defining pro-worker AI as tools that *extend* the expertise of non-elite workers, with a five-policy package (equalize labor/capital tax rates; update workplace surveillance regulations; fund human-complementary research; create AI center of expertise in government; assess human-complementary tech for public education and healthcare). This is a concrete, falsifiable, citable form of the "AI commonwealth" frame the steward submission proposed.
